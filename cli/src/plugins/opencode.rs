//! OpenCode plugin generator — scaffold only.
//!
//! The OpenCode plugin format isn't settled. This generator writes a TODO marker
...
pub fn generate(_agents: &[DiscoveredAgent], plugin_root: &Path) -> Result<usize, AwareError> {
    ...
    let readme = "# AWARE Plugin for OpenCode\n\n\
                  The OpenCode plugin format is not yet settled. This directory is a placeholder.\n\n\
