...
- npm / pnpm / yarn / bun: append `@0.16.0` to the package name (e.g. `pnpm add -g @aware-aeco/cli@0.16.0`)
- curl: `... | bash -s -- --version 0.16.0`
- PowerShell: `$env:AWARE_VERSION = "0.16.0"; iex (...)`
