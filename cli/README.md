...
- npm / pnpm / yarn / bun: append `@0.28.1` to the package name (e.g. `pnpm add -g @aware-aeco/cli@0.28.1`)
- curl: `... | bash -s -- --version 0.28.1`
- PowerShell: `$env:AWARE_VERSION = "0.28.1"; iex (...)`
