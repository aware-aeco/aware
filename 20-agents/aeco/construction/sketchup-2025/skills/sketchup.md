...
description: This skill encodes the sketchup 2025.0 surface of the Sketchup namespace — 93 types with full vendor-documented methods, properties, events, and behavioral remarks. Read when composing apps that touch any of: Animation, AppObserver, ArcCurve, AttributeDictionaries, AttributeDictionary, Axes, Behavior, Camera, and 85 more types.
---

# Sketchup

Auto-generated from vendor docs for sketchup 2025.0. 93 types in this namespace.
