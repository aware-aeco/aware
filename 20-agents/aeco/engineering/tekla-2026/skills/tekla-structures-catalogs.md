...
- `IsCLBProfile` (object, get/set) — Whether the profile is a clb profile.
- `IsHardcodedProfile` (object, get/set) — Whether the profile is a parametric user-defined hard coded profile.
