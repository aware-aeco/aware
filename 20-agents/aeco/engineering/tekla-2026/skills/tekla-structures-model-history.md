...
description: This skill encodes the tekla 2026.0 surface of the Tekla.Structures.Model.History namespace — 4 types with full vendor-documented methods, properties, events, and behavioral remarks. Read when composing apps that touch any of: ModelHistory, ModificationStamp, ModificationInfo, ModifiedObjectInfo.
---
