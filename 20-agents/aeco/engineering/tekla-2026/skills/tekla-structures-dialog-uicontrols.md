...
description: This skill encodes the tekla 2026.0 surface of the Tekla.Structures.Dialog.UIControls namespace — 52 types with full vendor-documented methods, properties, events, and behavioral remarks. Read when composing apps that touch any of: BoltCatalogSize, BindableRadioButton, BoltCatalogStandard, CommitAction, CreateApplyCancel, ComponentCatalog, CreateDialog, DataGrid, and 44 more types.
---
