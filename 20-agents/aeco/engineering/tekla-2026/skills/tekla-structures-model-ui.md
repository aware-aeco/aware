...
description: This skill encodes the tekla 2026.0 surface of the Tekla.Structures.Model.UI namespace — 24 types with full vendor-documented methods, properties, events, and behavioral remarks. Read when composing apps that touch any of: ClipBox, ClipPlane, ClipPlaneCollection, Color, GraphicPolyLine, GraphicsDrawer, ModelObjectSelector, Mesh, and 16 more types.
---
...
### Constructors
- `public ClipBox(View view, IEnumerable<ClipPlane> clipPlanes = null)` — Initializes a new instance of the ClipBox class with 6 clip planes.
...
### Properties
- `ClipPlanes` (List<ClipPlane>, get) — Gets or sets the clip planes contained by this clip box.
- `View` (View, get) — Gets the view the clip box belongs to.
...
#### `public static void UnhideParts()`
...
#### `public static bool SetActiveView(View view)`

Set the current active MDI child window view.

**Parameters:**
- `view` (Tekla.Structures.Model.UI.View)

**Returns:** `Boolean` — The view to set as active.
