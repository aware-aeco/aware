...
description: This skill encodes the tekla-plugin-sdk 2025.0 surface of the Fusion.Data.Query namespace — 7 types with full vendor-documented methods, properties, events, and behavioral remarks. Read when composing apps that touch any of: Column, Parameter, Parameters, QueryBuilder, QueryExtensions, Result`1, Results`1.
---
