...
description: This skill encodes the tekla-plugin-sdk 2026.0 surface of the Fusion namespace — 135 types with full vendor-documented methods, properties, events, and behavioral remarks. Read when composing apps that touch any of: Angle, AngleUnit, App, Area, AreaPerLength, AreaUnit, AuthorizationAvailableResponse, AuthorizationResponse, and 127 more types.
---

# Fusion

Auto-generated from vendor docs for tekla-plugin-sdk 2026.0. 135 types in this namespace.
...
#### `string ShowMessageDialogWithStartupLocationAndOwner(string text, string caption, string icon, string[] buttons, string defaultButton, string cancelButton, System.Windows.WindowStartupLocation windowStartupLocation, nint dialogOwner)`

ShowMessageDialogWithStartupLocationAndOwner method of IHostUI.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.IHostUI.ShowMessageDialogWithStartupLocationAndOwner%28System.String%2CSystem.String%2CSystem.String%2CSystem.String%5B%5D%2CSystem.String%2CSystem.String%2CSystem.Windows.WindowStartupLocation%2CSystem.IntPtr%29)
...
LinearMoment struct in Fusion.

[Vendor docs](https://www.nuget.org/packages/TeklaFusion#T:Fusion.LinearMoment)

### Constructors
- `LinearMoment(double kilogramMeterPerMeter)` — Constructs a new LinearMoment.

### Methods
#### `static Fusion.LinearMoment Abs(Fusion.LinearMoment linearMoment)`

Abs method of LinearMoment.

**Parameters:**
- `linearMoment` (Fusion.LinearMoment)

**Returns:** `Fusion.LinearMoment` — 

[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.LinearMoment.Abs%28Fusion.LinearMoment%29)

#### `int CompareTo(Fusion.LinearMoment other)`

CompareTo method of LinearMoment.

**Parameters:**
- `other` (Fusion.LinearMoment)

**Returns:** `int` — 

[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.LinearMoment.CompareTo%28Fusion.LinearMoment%29)
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.LinearMoment.CompareTo%28System.Object%29)

#### `bool Equals(Fusion.LinearMoment other)`

Equals method of LinearMoment.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.LinearMoment.Equals%28Fusion.LinearMoment%29)
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.LinearMoment.Equals%28System.Object%29)

#### `static Fusion.LinearMoment From(double value, Fusion.LinearMomentUnit unit)`

From method of LinearMoment.

**Parameters:**
- `value` (double)
- `unit` (Fusion.LinearMomentUnit)

**Returns:** `Fusion.LinearMoment` — 

[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.LinearMoment.From%28System.Double%2CFusion.LinearMomentUnit%29)

#### `int GetHashCode()`

GetHashCode method of LinearMoment.

**Returns:** `int` — 

[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.LinearMoment.GetHashCode)

#### `static bool IsInfinity(Fusion.LinearMoment linearMoment)`

IsInfinity method of LinearMoment.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.LinearMoment.IsInfinity%28Fusion.LinearMoment%29)

#### `static bool IsNaN(Fusion.LinearMoment linearMoment)`

IsNaN method of LinearMoment.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.LinearMoment.IsNaN%28Fusion.LinearMoment%29)

#### `static bool IsNegativeInfinity(Fusion.LinearMoment linearMoment)`

IsNegativeInfinity method of LinearMoment.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.LinearMoment.IsNegativeInfinity%28Fusion.LinearMoment%29)

#### `static bool IsPositiveInfinity(Fusion.LinearMoment linearMoment)`

IsPositiveInfinity method of LinearMoment.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.LinearMoment.IsPositiveInfinity%28Fusion.LinearMoment%29)

#### `static Fusion.LinearMoment Max(Fusion.LinearMoment left, Fusion.LinearMoment right)`

Max method of LinearMoment.

**Parameters:**
- `left` (Fusion.LinearMoment)
- `right` (Fusion.LinearMoment)

**Returns:** `Fusion.LinearMoment` — 

[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.LinearMoment.Max%28Fusion.LinearMoment%2CFusion.LinearMoment%29)

#### `static Fusion.LinearMoment Min(Fusion.LinearMoment left, Fusion.LinearMoment right)`

Min method of LinearMoment.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.LinearMoment.Min%28Fusion.LinearMoment%2CFusion.LinearMoment%29)

#### `bool Near(Fusion.LinearMoment other, int allowedErrorInUnitsInLastPlace = 10)`

Near method of LinearMoment.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.LinearMoment.Near%28Fusion.LinearMoment%2CSystem.Int32%29)

#### `static Fusion.LinearMoment Round(Fusion.LinearMoment linearMoment, Fusion.LinearMoment precision, Fusion.RoundingMode roundingMode)`

Round method of LinearMoment.

**Parameters:**
- `linearMoment` (Fusion.LinearMoment)
- `precision` (Fusion.LinearMoment)
- `roundingMode` (Fusion.RoundingMode)

**Returns:** `Fusion.LinearMoment` — 

[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.LinearMoment.Round%28Fusion.LinearMoment%2CFusion.LinearMoment%2CFusion.RoundingMode%29)

#### `static int Sign(Fusion.LinearMoment linearMoment)`

Sign method of LinearMoment.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.LinearMoment.Sign%28Fusion.LinearMoment%29)

#### `double To(Fusion.LinearMomentUnit unit)`

To method of LinearMoment.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.LinearMoment.To%28Fusion.LinearMomentUnit%29)

#### `string ToString()`

ToString method of LinearMoment.

**Returns:** `string` — 

[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.LinearMoment.ToString)
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.LinearMoment.ToString%28System.String%2CSystem.IFormatProvider%29)

#### `static Fusion.LinearMoment op_Addition(Fusion.LinearMoment left, Fusion.LinearMoment right)`

op_Addition method of LinearMoment.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.LinearMoment.op_Addition%28Fusion.LinearMoment%2CFusion.LinearMoment%29)

#### `static Fusion.LinearMoment op_Division(Fusion.LinearMoment left, double right)`

op_Division method of LinearMoment.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.LinearMoment.op_Division%28Fusion.LinearMoment%2CSystem.Double%29)

#### `static Fusion.LinearMoment op_Division(double left, Fusion.LinearMoment right)`
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.LinearMoment.op_Division%28System.Double%2CFusion.LinearMoment%29)

#### `static double op_Division(Fusion.LinearMoment left, Fusion.LinearMoment right)`
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.LinearMoment.op_Division%28Fusion.LinearMoment%2CFusion.LinearMoment%29)

#### `static bool op_Equality(Fusion.LinearMoment left, Fusion.LinearMoment right)`

op_Equality method of LinearMoment.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.LinearMoment.op_Equality%28Fusion.LinearMoment%2CFusion.LinearMoment%29)

#### `static bool op_GreaterThan(Fusion.LinearMoment left, Fusion.LinearMoment right)`

op_GreaterThan method of LinearMoment.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.LinearMoment.op_GreaterThan%28Fusion.LinearMoment%2CFusion.LinearMoment%29)

#### `static bool op_GreaterThanOrEqual(Fusion.LinearMoment left, Fusion.LinearMoment right)`

op_GreaterThanOrEqual method of LinearMoment.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.LinearMoment.op_GreaterThanOrEqual%28Fusion.LinearMoment%2CFusion.LinearMoment%29)

#### `static bool op_Inequality(Fusion.LinearMoment left, Fusion.LinearMoment right)`

op_Inequality method of LinearMoment.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.LinearMoment.op_Inequality%28Fusion.LinearMoment%2CFusion.LinearMoment%29)

#### `static bool op_LessThan(Fusion.LinearMoment left, Fusion.LinearMoment right)`

op_LessThan method of LinearMoment.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.LinearMoment.op_LessThan%28Fusion.LinearMoment%2CFusion.LinearMoment%29)

#### `static bool op_LessThanOrEqual(Fusion.LinearMoment left, Fusion.LinearMoment right)`

op_LessThanOrEqual method of LinearMoment.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.LinearMoment.op_LessThanOrEqual%28Fusion.LinearMoment%2CFusion.LinearMoment%29)

#### `static Fusion.LinearMoment op_Modulus(Fusion.LinearMoment left, Fusion.LinearMoment right)`

op_Modulus method of LinearMoment.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.LinearMoment.op_Modulus%28Fusion.LinearMoment%2CFusion.LinearMoment%29)

#### `static Fusion.LinearMoment op_Multiply(Fusion.LinearMoment left, double right)`

op_Multiply method of LinearMoment.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.LinearMoment.op_Multiply%28Fusion.LinearMoment%2CSystem.Double%29)

#### `static Fusion.LinearMoment op_Multiply(double left, Fusion.LinearMoment right)`
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.LinearMoment.op_Multiply%28System.Double%2CFusion.LinearMoment%29)

#### `static Fusion.LinearMoment op_Subtraction(Fusion.LinearMoment left, Fusion.LinearMoment right)`

op_Subtraction method of LinearMoment.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.LinearMoment.op_Subtraction%28Fusion.LinearMoment%2CFusion.LinearMoment%29)

#### `static Fusion.LinearMoment op_UnaryNegation(Fusion.LinearMoment linearMoment)`

op_UnaryNegation method of LinearMoment.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.LinearMoment.op_UnaryNegation%28Fusion.LinearMoment%29)

### Properties
- `KilogramMeterPerMeter` (double, get) — KilogramMeterPerMeter property of LinearMoment.

## LinearMomentUnit (enum)

LinearMomentUnit enum in Fusion.

[Vendor docs](https://www.nuget.org/packages/TeklaFusion#T:Fusion.LinearMomentUnit)

### Values
- `KilogramMeterPerMeter` = `0`
- `TonneMeterPerMeter` = `1`
- `NewtonMeterPerMeter` = `2`
- `DecaNewtonMeterPerMeter` = `3`
- `KiloNewtonMeterPerMeter` = `4`
- `PoundForceFootPerFoot` = `5`
- `KiloPoundForceFootPerFoot` = `6`
...
Moment struct in Fusion.

[Vendor docs](https://www.nuget.org/packages/TeklaFusion#T:Fusion.Moment)

### Constructors
- `Moment(double kilogramMeter)` — Constructs a new Moment.

### Methods
#### `static Fusion.Moment Abs(Fusion.Moment moment)`

Abs method of Moment.

**Parameters:**
- `moment` (Fusion.Moment)

**Returns:** `Fusion.Moment` — 

[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Moment.Abs%28Fusion.Moment%29)

#### `int CompareTo(Fusion.Moment other)`

CompareTo method of Moment.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Moment.CompareTo%28Fusion.Moment%29)
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Moment.CompareTo%28System.Object%29)

#### `bool Equals(Fusion.Moment other)`

Equals method of Moment.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Moment.Equals%28Fusion.Moment%29)
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Moment.Equals%28System.Object%29)

#### `static Fusion.Moment From(double value, Fusion.MomentUnit unit)`

From method of Moment.

**Parameters:**
- `value` (double)
- `unit` (Fusion.MomentUnit)

**Returns:** `Fusion.Moment` — 

[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Moment.From%28System.Double%2CFusion.MomentUnit%29)

#### `int GetHashCode()`

GetHashCode method of Moment.

**Returns:** `int` — 

[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Moment.GetHashCode)

#### `static bool IsInfinity(Fusion.Moment moment)`

IsInfinity method of Moment.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Moment.IsInfinity%28Fusion.Moment%29)

#### `static bool IsNaN(Fusion.Moment moment)`

IsNaN method of Moment.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Moment.IsNaN%28Fusion.Moment%29)

#### `static bool IsNegativeInfinity(Fusion.Moment moment)`

IsNegativeInfinity method of Moment.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Moment.IsNegativeInfinity%28Fusion.Moment%29)

#### `static bool IsPositiveInfinity(Fusion.Moment moment)`

IsPositiveInfinity method of Moment.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Moment.IsPositiveInfinity%28Fusion.Moment%29)

#### `static Fusion.Moment Max(Fusion.Moment left, Fusion.Moment right)`

Max method of Moment.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Moment.Max%28Fusion.Moment%2CFusion.Moment%29)

#### `static Fusion.Moment Min(Fusion.Moment left, Fusion.Moment right)`

Min method of Moment.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Moment.Min%28Fusion.Moment%2CFusion.Moment%29)

#### `bool Near(Fusion.Moment other, int allowedErrorInUnitsInLastPlace = 10)`

Near method of Moment.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Moment.Near%28Fusion.Moment%2CSystem.Int32%29)

#### `static Fusion.Moment Round(Fusion.Moment moment, Fusion.Moment precision, Fusion.RoundingMode roundingMode)`

Round method of Moment.

**Parameters:**
- `moment` (Fusion.Moment)
- `precision` (Fusion.Moment)
- `roundingMode` (Fusion.RoundingMode)

**Returns:** `Fusion.Moment` — 

[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Moment.Round%28Fusion.Moment%2CFusion.Moment%2CFusion.RoundingMode%29)

#### `static int Sign(Fusion.Moment moment)`

Sign method of Moment.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Moment.Sign%28Fusion.Moment%29)

#### `double To(Fusion.MomentUnit unit)`
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Moment.To%28Fusion.MomentUnit%29)

#### `string ToString()`

ToString method of Moment.

**Returns:** `string` — 

[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Moment.ToString)
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Moment.ToString%28System.String%2CSystem.IFormatProvider%29)

#### `static Fusion.Moment op_Addition(Fusion.Moment left, Fusion.Moment right)`

op_Addition method of Moment.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Moment.op_Addition%28Fusion.Moment%2CFusion.Moment%29)

#### `static Fusion.Moment op_Division(Fusion.Moment left, double right)`

op_Division method of Moment.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Moment.op_Division%28Fusion.Moment%2CSystem.Double%29)

#### `static double op_Division(Fusion.Moment left, Fusion.Moment right)`
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Moment.op_Division%28Fusion.Moment%2CFusion.Moment%29)

#### `static bool op_Equality(Fusion.Moment left, Fusion.Moment right)`

op_Equality method of Moment.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Moment.op_Equality%28Fusion.Moment%2CFusion.Moment%29)

#### `static bool op_GreaterThan(Fusion.Moment left, Fusion.Moment right)`

op_GreaterThan method of Moment.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Moment.op_GreaterThan%28Fusion.Moment%2CFusion.Moment%29)

#### `static bool op_GreaterThanOrEqual(Fusion.Moment left, Fusion.Moment right)`

op_GreaterThanOrEqual method of Moment.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Moment.op_GreaterThanOrEqual%28Fusion.Moment%2CFusion.Moment%29)

#### `static bool op_Inequality(Fusion.Moment left, Fusion.Moment right)`

op_Inequality method of Moment.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Moment.op_Inequality%28Fusion.Moment%2CFusion.Moment%29)

#### `static bool op_LessThan(Fusion.Moment left, Fusion.Moment right)`

op_LessThan method of Moment.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Moment.op_LessThan%28Fusion.Moment%2CFusion.Moment%29)

#### `static bool op_LessThanOrEqual(Fusion.Moment left, Fusion.Moment right)`

op_LessThanOrEqual method of Moment.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Moment.op_LessThanOrEqual%28Fusion.Moment%2CFusion.Moment%29)

#### `static Fusion.Moment op_Modulus(Fusion.Moment left, Fusion.Moment right)`

op_Modulus method of Moment.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Moment.op_Modulus%28Fusion.Moment%2CFusion.Moment%29)

#### `static Fusion.Moment op_Multiply(Fusion.Moment left, double right)`

op_Multiply method of Moment.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Moment.op_Multiply%28Fusion.Moment%2CSystem.Double%29)

#### `static Fusion.Moment op_Multiply(double left, Fusion.Moment right)`
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Moment.op_Multiply%28System.Double%2CFusion.Moment%29)

#### `static Fusion.Moment op_Subtraction(Fusion.Moment left, Fusion.Moment right)`

op_Subtraction method of Moment.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Moment.op_Subtraction%28Fusion.Moment%2CFusion.Moment%29)

#### `static Fusion.Moment op_UnaryNegation(Fusion.Moment left)`

op_UnaryNegation method of Moment.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Moment.op_UnaryNegation%28Fusion.Moment%29)

### Properties
- `KilogramMeter` (double, get) — KilogramMeter property of Moment.

## MomentUnit (enum)

MomentUnit enum in Fusion.

[Vendor docs](https://www.nuget.org/packages/TeklaFusion#T:Fusion.MomentUnit)
...
Pressure struct in Fusion.

[Vendor docs](https://www.nuget.org/packages/TeklaFusion#T:Fusion.Pressure)

### Constructors
- `Pressure(double newtonPerSquareMeter)` — Constructs a new Pressure.

### Methods
#### `static Fusion.Pressure Abs(Fusion.Pressure pressure)`

Abs method of Pressure.

**Parameters:**
- `pressure` (Fusion.Pressure)

**Returns:** `Fusion.Pressure` — 

[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Pressure.Abs%28Fusion.Pressure%29)

#### `int CompareTo(Fusion.Pressure other)`

CompareTo method of Pressure.

**Parameters:**
- `other` (Fusion.Pressure)

**Returns:** `int` — 

[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Pressure.CompareTo%28Fusion.Pressure%29)
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Pressure.CompareTo%28System.Object%29)

#### `bool Equals(Fusion.Pressure other)`

Equals method of Pressure.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Pressure.Equals%28Fusion.Pressure%29)
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Pressure.Equals%28System.Object%29)

#### `static Fusion.Pressure From(double pressure, Fusion.PressureUnit pressureUnit)`

From method of Pressure.

**Parameters:**
- `pressure` (double)
- `pressureUnit` (Fusion.PressureUnit)

**Returns:** `Fusion.Pressure` — 

[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Pressure.From%28System.Double%2CFusion.PressureUnit%29)

#### `int GetHashCode()`

GetHashCode method of Pressure.

**Returns:** `int` — 

[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Pressure.GetHashCode)

#### `static bool IsInfinity(Fusion.Pressure pressure)`

IsInfinity method of Pressure.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Pressure.IsInfinity%28Fusion.Pressure%29)

#### `static bool IsNaN(Fusion.Pressure pressure)`

IsNaN method of Pressure.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Pressure.IsNaN%28Fusion.Pressure%29)

#### `static bool IsNegativeInfinity(Fusion.Pressure pressure)`

IsNegativeInfinity method of Pressure.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Pressure.IsNegativeInfinity%28Fusion.Pressure%29)

#### `static bool IsPositiveInfinity(Fusion.Pressure pressure)`

IsPositiveInfinity method of Pressure.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Pressure.IsPositiveInfinity%28Fusion.Pressure%29)

#### `static Fusion.Pressure Max(Fusion.Pressure a, Fusion.Pressure b)`

Max method of Pressure.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Pressure.Max%28Fusion.Pressure%2CFusion.Pressure%29)

#### `static Fusion.Pressure Min(Fusion.Pressure a, Fusion.Pressure b)`

Min method of Pressure.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Pressure.Min%28Fusion.Pressure%2CFusion.Pressure%29)

#### `bool Near(Fusion.Pressure other, int allowedErrorInUnitsInLastPlace = 10)`

Near method of Pressure.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Pressure.Near%28Fusion.Pressure%2CSystem.Int32%29)

#### `static Fusion.Pressure Round(Fusion.Pressure pressure, Fusion.Pressure precision, Fusion.RoundingMode roundingMode)`

Round method of Pressure.

**Parameters:**
- `pressure` (Fusion.Pressure)
- `precision` (Fusion.Pressure)
- `roundingMode` (Fusion.RoundingMode)

**Returns:** `Fusion.Pressure` — 

[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Pressure.Round%28Fusion.Pressure%2CFusion.Pressure%2CFusion.RoundingMode%29)

#### `static int Sign(Fusion.Pressure pressure)`

Sign method of Pressure.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Pressure.Sign%28Fusion.Pressure%29)

#### `double To(Fusion.PressureUnit pressureUnit)`

To method of Pressure.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Pressure.To%28Fusion.PressureUnit%29)

#### `string ToString()`

ToString method of Pressure.

**Returns:** `string` — 

[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Pressure.ToString)
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Pressure.ToString%28System.String%2CSystem.IFormatProvider%29)

#### `static Fusion.Pressure op_Addition(Fusion.Pressure a, Fusion.Pressure b)`

op_Addition method of Pressure.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Pressure.op_Addition%28Fusion.Pressure%2CFusion.Pressure%29)

#### `static Fusion.Pressure op_Division(Fusion.Pressure a, double b)`

op_Division method of Pressure.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Pressure.op_Division%28Fusion.Pressure%2CSystem.Double%29)

#### `static double op_Division(Fusion.Pressure a, Fusion.Pressure b)`
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Pressure.op_Division%28Fusion.Pressure%2CFusion.Pressure%29)

#### `static bool op_Equality(Fusion.Pressure a, Fusion.Pressure b)`

op_Equality method of Pressure.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Pressure.op_Equality%28Fusion.Pressure%2CFusion.Pressure%29)

#### `static bool op_GreaterThan(Fusion.Pressure a, Fusion.Pressure b)`

op_GreaterThan method of Pressure.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Pressure.op_GreaterThan%28Fusion.Pressure%2CFusion.Pressure%29)

#### `static bool op_GreaterThanOrEqual(Fusion.Pressure a, Fusion.Pressure b)`

op_GreaterThanOrEqual method of Pressure.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Pressure.op_GreaterThanOrEqual%28Fusion.Pressure%2CFusion.Pressure%29)

#### `static bool op_Inequality(Fusion.Pressure a, Fusion.Pressure b)`

op_Inequality method of Pressure.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Pressure.op_Inequality%28Fusion.Pressure%2CFusion.Pressure%29)

#### `static bool op_LessThan(Fusion.Pressure a, Fusion.Pressure b)`

op_LessThan method of Pressure.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Pressure.op_LessThan%28Fusion.Pressure%2CFusion.Pressure%29)

#### `static bool op_LessThanOrEqual(Fusion.Pressure a, Fusion.Pressure b)`

op_LessThanOrEqual method of Pressure.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Pressure.op_LessThanOrEqual%28Fusion.Pressure%2CFusion.Pressure%29)

#### `static Fusion.Pressure op_Modulus(Fusion.Pressure a, Fusion.Pressure b)`

op_Modulus method of Pressure.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Pressure.op_Modulus%28Fusion.Pressure%2CFusion.Pressure%29)

#### `static Fusion.Pressure op_Multiply(Fusion.Pressure a, double b)`

op_Multiply method of Pressure.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Pressure.op_Multiply%28Fusion.Pressure%2CSystem.Double%29)

#### `static Fusion.Pressure op_Multiply(double a, Fusion.Pressure b)`
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Pressure.op_Multiply%28System.Double%2CFusion.Pressure%29)

#### `static Fusion.Pressure op_Subtraction(Fusion.Pressure a, Fusion.Pressure b)`

op_Subtraction method of Pressure.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Pressure.op_Subtraction%28Fusion.Pressure%2CFusion.Pressure%29)

#### `static Fusion.Pressure op_UnaryNegation(Fusion.Pressure a)`

op_UnaryNegation method of Pressure.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.Pressure.op_UnaryNegation%28Fusion.Pressure%29)

### Properties
- `NewtonPerSquareMeter` (double, get) — NewtonPerSquareMeter property of Pressure.
...
PressureUnit enum in Fusion.

[Vendor docs](https://www.nuget.org/packages/TeklaFusion#T:Fusion.PressureUnit)

### Values
- `NewtonPerSquareMeter` = `0`
- `NewtonPerSquareCentimeter` = `1`
- `NewtonPerSquareMillimeter` = `2`
- `KilogramPerSquareMeter` = `3`
- `KilogramPerSquareCentimeter` = `4`
- `KilogramPerSquareMillimeter` = `5`
- `TonnePerSquareMeter` = `6`
- `TonnePerSquareCentimeter` = `7`
- `TonnePerSquareMillimeter` = `8`
- `DecaNewtonPerSquareMeter` = `9`
- `DecaNewtonPerSquareCentimeter` = `10`
- `DecaNewtonPerSquareMillimeter` = `11`
- `KiloNewtonPerSquareMeter` = `12`
- `KiloNewtonPerSquareCentimeter` = `13`
- `KiloNewtonPerSquareMillimeter` = `14`
- `PoundForcePerSquareInch` = `15`
- `PoundForcePerSquareFoot` = `16`
- `KiloPoundForcePerSquareInch` = `17`
- `KiloPoundForcePerSquareFoot` = `18`
...
## RotationSpringConstant (struct)

RotationSpringConstant struct in Fusion.

[Vendor docs](https://www.nuget.org/packages/TeklaFusion#T:Fusion.RotationSpringConstant)

### Constructors
- `RotationSpringConstant(double newtonMeterPerRadian)` — Constructs a new RotationSpringConstant.

### Methods
#### `static Fusion.RotationSpringConstant Abs(Fusion.RotationSpringConstant rotationSpringConstant)`

Abs method of RotationSpringConstant.

**Parameters:**
- `rotationSpringConstant` (Fusion.RotationSpringConstant)

**Returns:** `Fusion.RotationSpringConstant` — 

[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.RotationSpringConstant.Abs%28Fusion.RotationSpringConstant%29)

#### `int CompareTo(Fusion.RotationSpringConstant obj)`

CompareTo method of RotationSpringConstant.

**Parameters:**
- `obj` (Fusion.RotationSpringConstant)

**Returns:** `int` — 

[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.RotationSpringConstant.CompareTo%28Fusion.RotationSpringConstant%29)
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.RotationSpringConstant.CompareTo%28System.Object%29)

#### `bool Equals(Fusion.RotationSpringConstant obj)`

Equals method of RotationSpringConstant.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.RotationSpringConstant.Equals%28Fusion.RotationSpringConstant%29)
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.RotationSpringConstant.Equals%28System.Object%29)

#### `static Fusion.RotationSpringConstant From(double rotationSpringConstant, Fusion.RotationSpringConstantUnit rotationSpringConstantUnit)`

From method of RotationSpringConstant.

**Parameters:**
- `rotationSpringConstant` (double)
- `rotationSpringConstantUnit` (Fusion.RotationSpringConstantUnit)

**Returns:** `Fusion.RotationSpringConstant` — 

[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.RotationSpringConstant.From%28System.Double%2CFusion.RotationSpringConstantUnit%29)

#### `int GetHashCode()`

GetHashCode method of RotationSpringConstant.

**Returns:** `int` — 

[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.RotationSpringConstant.GetHashCode)

#### `static bool IsInfinity(Fusion.RotationSpringConstant rotationSpringConstant)`

IsInfinity method of RotationSpringConstant.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.RotationSpringConstant.IsInfinity%28Fusion.RotationSpringConstant%29)

#### `static bool IsNaN(Fusion.RotationSpringConstant rotationSpringConstant)`

IsNaN method of RotationSpringConstant.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.RotationSpringConstant.IsNaN%28Fusion.RotationSpringConstant%29)

#### `static bool IsNegativeInfinity(Fusion.RotationSpringConstant rotationSpringConstant)`

IsNegativeInfinity method of RotationSpringConstant.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.RotationSpringConstant.IsNegativeInfinity%28Fusion.RotationSpringConstant%29)

#### `static bool IsPositiveInfinity(Fusion.RotationSpringConstant rotationSpringConstant)`

IsPositiveInfinity method of RotationSpringConstant.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.RotationSpringConstant.IsPositiveInfinity%28Fusion.RotationSpringConstant%29)

#### `static Fusion.RotationSpringConstant Max(Fusion.RotationSpringConstant a, Fusion.RotationSpringConstant b)`

Max method of RotationSpringConstant.

**Parameters:**
- `a` (Fusion.RotationSpringConstant)
- `b` (Fusion.RotationSpringConstant)

**Returns:** `Fusion.RotationSpringConstant` — 

[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.RotationSpringConstant.Max%28Fusion.RotationSpringConstant%2CFusion.RotationSpringConstant%29)

#### `static Fusion.RotationSpringConstant Min(Fusion.RotationSpringConstant a, Fusion.RotationSpringConstant b)`

Min method of RotationSpringConstant.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.RotationSpringConstant.Min%28Fusion.RotationSpringConstant%2CFusion.RotationSpringConstant%29)

#### `bool Near(Fusion.RotationSpringConstant other, int allowedErrorInUnitsInLastPlace = 10)`

Near method of RotationSpringConstant.

**Parameters:**
- `other` (Fusion.RotationSpringConstant)
- `allowedErrorInUnitsInLastPlace` (int)

**Returns:** `bool` — 

[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.RotationSpringConstant.Near%28Fusion.RotationSpringConstant%2CSystem.Int32%29)

#### `static Fusion.RotationSpringConstant Round(Fusion.RotationSpringConstant rotationSpringConstant, Fusion.RotationSpringConstant precision, Fusion.RoundingMode roundingMode)`

Round method of RotationSpringConstant.

**Parameters:**
- `rotationSpringConstant` (Fusion.RotationSpringConstant)
- `precision` (Fusion.RotationSpringConstant)
- `roundingMode` (Fusion.RoundingMode)

**Returns:** `Fusion.RotationSpringConstant` — 

[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.RotationSpringConstant.Round%28Fusion.RotationSpringConstant%2CFusion.RotationSpringConstant%2CFusion.RoundingMode%29)

#### `static int Sign(Fusion.RotationSpringConstant rotationSpringConstant)`

Sign method of RotationSpringConstant.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.RotationSpringConstant.Sign%28Fusion.RotationSpringConstant%29)

#### `double To(Fusion.RotationSpringConstantUnit rotationSpringConstantUnit)`

To method of RotationSpringConstant.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.RotationSpringConstant.To%28Fusion.RotationSpringConstantUnit%29)

#### `string ToString()`

ToString method of RotationSpringConstant.

**Returns:** `string` — 

[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.RotationSpringConstant.ToString)
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.RotationSpringConstant.ToString%28System.String%2CSystem.IFormatProvider%29)

#### `static Fusion.RotationSpringConstant op_Addition(Fusion.RotationSpringConstant a, Fusion.RotationSpringConstant b)`

op_Addition method of RotationSpringConstant.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.RotationSpringConstant.op_Addition%28Fusion.RotationSpringConstant%2CFusion.RotationSpringConstant%29)

#### `static Fusion.RotationSpringConstant op_Division(Fusion.RotationSpringConstant a, double b)`

op_Division method of RotationSpringConstant.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.RotationSpringConstant.op_Division%28Fusion.RotationSpringConstant%2CSystem.Double%29)

#### `static double op_Division(Fusion.RotationSpringConstant a, Fusion.RotationSpringConstant b)`
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.RotationSpringConstant.op_Division%28Fusion.RotationSpringConstant%2CFusion.RotationSpringConstant%29)

#### `static bool op_Equality(Fusion.RotationSpringConstant a, Fusion.RotationSpringConstant b)`

op_Equality method of RotationSpringConstant.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.RotationSpringConstant.op_Equality%28Fusion.RotationSpringConstant%2CFusion.RotationSpringConstant%29)

#### `static bool op_GreaterThan(Fusion.RotationSpringConstant a, Fusion.RotationSpringConstant b)`

op_GreaterThan method of RotationSpringConstant.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.RotationSpringConstant.op_GreaterThan%28Fusion.RotationSpringConstant%2CFusion.RotationSpringConstant%29)

#### `static bool op_GreaterThanOrEqual(Fusion.RotationSpringConstant a, Fusion.RotationSpringConstant b)`

op_GreaterThanOrEqual method of RotationSpringConstant.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.RotationSpringConstant.op_GreaterThanOrEqual%28Fusion.RotationSpringConstant%2CFusion.RotationSpringConstant%29)

#### `static bool op_Inequality(Fusion.RotationSpringConstant a, Fusion.RotationSpringConstant b)`

op_Inequality method of RotationSpringConstant.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.RotationSpringConstant.op_Inequality%28Fusion.RotationSpringConstant%2CFusion.RotationSpringConstant%29)

#### `static bool op_LessThan(Fusion.RotationSpringConstant a, Fusion.RotationSpringConstant b)`

op_LessThan method of RotationSpringConstant.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.RotationSpringConstant.op_LessThan%28Fusion.RotationSpringConstant%2CFusion.RotationSpringConstant%29)

#### `static bool op_LessThanOrEqual(Fusion.RotationSpringConstant a, Fusion.RotationSpringConstant b)`

op_LessThanOrEqual method of RotationSpringConstant.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.RotationSpringConstant.op_LessThanOrEqual%28Fusion.RotationSpringConstant%2CFusion.RotationSpringConstant%29)

#### `static Fusion.RotationSpringConstant op_Modulus(Fusion.RotationSpringConstant a, Fusion.RotationSpringConstant b)`

op_Modulus method of RotationSpringConstant.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.RotationSpringConstant.op_Modulus%28Fusion.RotationSpringConstant%2CFusion.RotationSpringConstant%29)

#### `static Fusion.RotationSpringConstant op_Multiply(Fusion.RotationSpringConstant a, double b)`

op_Multiply method of RotationSpringConstant.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.RotationSpringConstant.op_Multiply%28Fusion.RotationSpringConstant%2CSystem.Double%29)

#### `static Fusion.RotationSpringConstant op_Multiply(double a, Fusion.RotationSpringConstant b)`
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.RotationSpringConstant.op_Multiply%28System.Double%2CFusion.RotationSpringConstant%29)

#### `static Fusion.RotationSpringConstant op_Subtraction(Fusion.RotationSpringConstant a, Fusion.RotationSpringConstant b)`

op_Subtraction method of RotationSpringConstant.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.RotationSpringConstant.op_Subtraction%28Fusion.RotationSpringConstant%2CFusion.RotationSpringConstant%29)

#### `static Fusion.RotationSpringConstant op_UnaryNegation(Fusion.RotationSpringConstant a)`

op_UnaryNegation method of RotationSpringConstant.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.RotationSpringConstant.op_UnaryNegation%28Fusion.RotationSpringConstant%29)

### Properties
- `NewtonMeterPerRadian` (double, get) — NewtonMeterPerRadian property of RotationSpringConstant.

## RotationSpringConstantUnit (enum)

RotationSpringConstantUnit enum in Fusion.

[Vendor docs](https://www.nuget.org/packages/TeklaFusion#T:Fusion.RotationSpringConstantUnit)

### Values
- `KilogramMeterPerRadian` = `0`
- `KilogramMeterPerDegree` = `1`
- `TonMeterPerRadian` = `2`
- `TonMeterPerDegree` = `3`
- `NewtonMeterPerRadian` = `4`
- `NewtonMeterPerDegree` = `5`
- `DecaNewtonMeterPerRadian` = `6`
- `DecaNewtonMeterPerDegree` = `7`
- `KiloNewtonMeterPerRadian` = `8`
- `KiloNewtonMeterPerDegree` = `9`
- `PoundForceInchPerRadian` = `10`
- `PoundForceInchPerDegree` = `11`
- `PoundForceFootPerRadian` = `12`
- `PoundForceFootPerDegree` = `13`
- `KiloPoundForceInchPerRadian` = `14`
- `KiloPoundForceInchPerDegree` = `15`
- `KiloPoundForceFootPerRadian` = `16`
- `KiloPoundForceFootPerDegree` = `17`
...
## ThermalExpansionCoefficient (struct)

ThermalExpansionCoefficient struct in Fusion.

[Vendor docs](https://www.nuget.org/packages/TeklaFusion#T:Fusion.ThermalExpansionCoefficient)

### Constructors
- `ThermalExpansionCoefficient(double perKelvin)` — Constructs a new ThermalExpansionCoefficient.

### Methods
#### `static Fusion.ThermalExpansionCoefficient Abs(Fusion.ThermalExpansionCoefficient thermalExpansionCoefficient)`

Abs method of ThermalExpansionCoefficient.

**Parameters:**
- `thermalExpansionCoefficient` (Fusion.ThermalExpansionCoefficient)

**Returns:** `Fusion.ThermalExpansionCoefficient` — 

[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.ThermalExpansionCoefficient.Abs%28Fusion.ThermalExpansionCoefficient%29)

#### `int CompareTo(Fusion.ThermalExpansionCoefficient other)`

CompareTo method of ThermalExpansionCoefficient.

**Parameters:**
- `other` (Fusion.ThermalExpansionCoefficient)

**Returns:** `int` — 

[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.ThermalExpansionCoefficient.CompareTo%28Fusion.ThermalExpansionCoefficient%29)
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.ThermalExpansionCoefficient.CompareTo%28System.Object%29)

#### `bool Equals(Fusion.ThermalExpansionCoefficient other)`

Equals method of ThermalExpansionCoefficient.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.ThermalExpansionCoefficient.Equals%28Fusion.ThermalExpansionCoefficient%29)
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.ThermalExpansionCoefficient.Equals%28System.Object%29)

#### `static Fusion.ThermalExpansionCoefficient From(double thermalExpansionCoefficient, Fusion.ThermalExpansionCoefficientUnit temperatureUnit)`

From method of ThermalExpansionCoefficient.

**Parameters:**
- `thermalExpansionCoefficient` (double)
- `temperatureUnit` (Fusion.ThermalExpansionCoefficientUnit)

**Returns:** `Fusion.ThermalExpansionCoefficient` — 

[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.ThermalExpansionCoefficient.From%28System.Double%2CFusion.ThermalExpansionCoefficientUnit%29)

#### `int GetHashCode()`

GetHashCode method of ThermalExpansionCoefficient.

**Returns:** `int` — 

[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.ThermalExpansionCoefficient.GetHashCode)

#### `static bool IsInfinity(Fusion.ThermalExpansionCoefficient thermalExpansionCoefficient)`

IsInfinity method of ThermalExpansionCoefficient.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.ThermalExpansionCoefficient.IsInfinity%28Fusion.ThermalExpansionCoefficient%29)

#### `static bool IsNaN(Fusion.ThermalExpansionCoefficient thermalExpansionCoefficient)`

IsNaN method of ThermalExpansionCoefficient.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.ThermalExpansionCoefficient.IsNaN%28Fusion.ThermalExpansionCoefficient%29)

#### `static bool IsNegativeInfinity(Fusion.ThermalExpansionCoefficient thermalExpansionCoefficient)`

IsNegativeInfinity method of ThermalExpansionCoefficient.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.ThermalExpansionCoefficient.IsNegativeInfinity%28Fusion.ThermalExpansionCoefficient%29)

#### `static bool IsPositiveInfinity(Fusion.ThermalExpansionCoefficient thermalExpansionCoefficient)`

IsPositiveInfinity method of ThermalExpansionCoefficient.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.ThermalExpansionCoefficient.IsPositiveInfinity%28Fusion.ThermalExpansionCoefficient%29)

#### `static Fusion.ThermalExpansionCoefficient Max(Fusion.ThermalExpansionCoefficient a, Fusion.ThermalExpansionCoefficient b)`

Max method of ThermalExpansionCoefficient.

**Parameters:**
- `a` (Fusion.ThermalExpansionCoefficient)
- `b` (Fusion.ThermalExpansionCoefficient)

**Returns:** `Fusion.ThermalExpansionCoefficient` — 

[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.ThermalExpansionCoefficient.Max%28Fusion.ThermalExpansionCoefficient%2CFusion.ThermalExpansionCoefficient%29)

#### `static Fusion.ThermalExpansionCoefficient Min(Fusion.ThermalExpansionCoefficient a, Fusion.ThermalExpansionCoefficient b)`

Min method of ThermalExpansionCoefficient.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.ThermalExpansionCoefficient.Min%28Fusion.ThermalExpansionCoefficient%2CFusion.ThermalExpansionCoefficient%29)

#### `bool Near(Fusion.ThermalExpansionCoefficient other, int allowedErrorInUnitsInLastPlace = 10)`

Near method of ThermalExpansionCoefficient.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.ThermalExpansionCoefficient.Near%28Fusion.ThermalExpansionCoefficient%2CSystem.Int32%29)

#### `static Fusion.ThermalExpansionCoefficient Round(Fusion.ThermalExpansionCoefficient thermalExpansionCoefficient, Fusion.ThermalExpansionCoefficient precision, Fusion.RoundingMode roundingMode)`

Round method of ThermalExpansionCoefficient.

**Parameters:**
- `thermalExpansionCoefficient` (Fusion.ThermalExpansionCoefficient)
- `precision` (Fusion.ThermalExpansionCoefficient)
- `roundingMode` (Fusion.RoundingMode)

**Returns:** `Fusion.ThermalExpansionCoefficient` — 

[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.ThermalExpansionCoefficient.Round%28Fusion.ThermalExpansionCoefficient%2CFusion.ThermalExpansionCoefficient%2CFusion.RoundingMode%29)

#### `static int Sign(Fusion.ThermalExpansionCoefficient thermalExpansionCoefficient)`

Sign method of ThermalExpansionCoefficient.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.ThermalExpansionCoefficient.Sign%28Fusion.ThermalExpansionCoefficient%29)

#### `double To(Fusion.ThermalExpansionCoefficientUnit temperatureUnit)`

To method of ThermalExpansionCoefficient.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.ThermalExpansionCoefficient.To%28Fusion.ThermalExpansionCoefficientUnit%29)

#### `string ToString()`

ToString method of ThermalExpansionCoefficient.

**Returns:** `string` — 

[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.ThermalExpansionCoefficient.ToString)
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.ThermalExpansionCoefficient.ToString%28System.String%2CSystem.IFormatProvider%29)

#### `static Fusion.ThermalExpansionCoefficient op_Addition(Fusion.ThermalExpansionCoefficient a, Fusion.ThermalExpansionCoefficient b)`

op_Addition method of ThermalExpansionCoefficient.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.ThermalExpansionCoefficient.op_Addition%28Fusion.ThermalExpansionCoefficient%2CFusion.ThermalExpansionCoefficient%29)

#### `static Fusion.ThermalExpansionCoefficient op_Division(Fusion.ThermalExpansionCoefficient a, double b)`

op_Division method of ThermalExpansionCoefficient.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.ThermalExpansionCoefficient.op_Division%28Fusion.ThermalExpansionCoefficient%2CSystem.Double%29)

#### `static double op_Division(Fusion.ThermalExpansionCoefficient a, Fusion.ThermalExpansionCoefficient b)`
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.ThermalExpansionCoefficient.op_Division%28Fusion.ThermalExpansionCoefficient%2CFusion.ThermalExpansionCoefficient%29)

#### `static bool op_Equality(Fusion.ThermalExpansionCoefficient a, Fusion.ThermalExpansionCoefficient b)`

op_Equality method of ThermalExpansionCoefficient.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.ThermalExpansionCoefficient.op_Equality%28Fusion.ThermalExpansionCoefficient%2CFusion.ThermalExpansionCoefficient%29)

#### `static bool op_GreaterThan(Fusion.ThermalExpansionCoefficient a, Fusion.ThermalExpansionCoefficient b)`

op_GreaterThan method of ThermalExpansionCoefficient.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.ThermalExpansionCoefficient.op_GreaterThan%28Fusion.ThermalExpansionCoefficient%2CFusion.ThermalExpansionCoefficient%29)

#### `static bool op_GreaterThanOrEqual(Fusion.ThermalExpansionCoefficient a, Fusion.ThermalExpansionCoefficient b)`

op_GreaterThanOrEqual method of ThermalExpansionCoefficient.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.ThermalExpansionCoefficient.op_GreaterThanOrEqual%28Fusion.ThermalExpansionCoefficient%2CFusion.ThermalExpansionCoefficient%29)

#### `static bool op_Inequality(Fusion.ThermalExpansionCoefficient a, Fusion.ThermalExpansionCoefficient b)`

op_Inequality method of ThermalExpansionCoefficient.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.ThermalExpansionCoefficient.op_Inequality%28Fusion.ThermalExpansionCoefficient%2CFusion.ThermalExpansionCoefficient%29)

#### `static bool op_LessThan(Fusion.ThermalExpansionCoefficient a, Fusion.ThermalExpansionCoefficient b)`

op_LessThan method of ThermalExpansionCoefficient.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.ThermalExpansionCoefficient.op_LessThan%28Fusion.ThermalExpansionCoefficient%2CFusion.ThermalExpansionCoefficient%29)

#### `static bool op_LessThanOrEqual(Fusion.ThermalExpansionCoefficient a, Fusion.ThermalExpansionCoefficient b)`

op_LessThanOrEqual method of ThermalExpansionCoefficient.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.ThermalExpansionCoefficient.op_LessThanOrEqual%28Fusion.ThermalExpansionCoefficient%2CFusion.ThermalExpansionCoefficient%29)

#### `static Fusion.ThermalExpansionCoefficient op_Modulus(Fusion.ThermalExpansionCoefficient a, Fusion.ThermalExpansionCoefficient b)`

op_Modulus method of ThermalExpansionCoefficient.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.ThermalExpansionCoefficient.op_Modulus%28Fusion.ThermalExpansionCoefficient%2CFusion.ThermalExpansionCoefficient%29)

#### `static Fusion.ThermalExpansionCoefficient op_Multiply(Fusion.ThermalExpansionCoefficient a, double b)`

op_Multiply method of ThermalExpansionCoefficient.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.ThermalExpansionCoefficient.op_Multiply%28Fusion.ThermalExpansionCoefficient%2CSystem.Double%29)

#### `static Fusion.ThermalExpansionCoefficient op_Multiply(double a, Fusion.ThermalExpansionCoefficient b)`
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.ThermalExpansionCoefficient.op_Multiply%28System.Double%2CFusion.ThermalExpansionCoefficient%29)

#### `static Fusion.ThermalExpansionCoefficient op_Subtraction(Fusion.ThermalExpansionCoefficient a, Fusion.ThermalExpansionCoefficient b)`

op_Subtraction method of ThermalExpansionCoefficient.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.ThermalExpansionCoefficient.op_Subtraction%28Fusion.ThermalExpansionCoefficient%2CFusion.ThermalExpansionCoefficient%29)

#### `static Fusion.ThermalExpansionCoefficient op_UnaryNegation(Fusion.ThermalExpansionCoefficient a)`

op_UnaryNegation method of ThermalExpansionCoefficient.
...
[Docs](https://www.nuget.org/packages/TeklaFusion#M%3AFusion.ThermalExpansionCoefficient.op_UnaryNegation%28Fusion.ThermalExpansionCoefficient%29)

### Properties
- `PerKelvin` (double, get) — PerKelvin property of ThermalExpansionCoefficient.

## ThermalExpansionCoefficientUnit (enum)

ThermalExpansionCoefficientUnit enum in Fusion.

[Vendor docs](https://www.nuget.org/packages/TeklaFusion#T:Fusion.ThermalExpansionCoefficientUnit)
