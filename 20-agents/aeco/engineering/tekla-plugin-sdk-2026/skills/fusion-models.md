...
description: This skill encodes the tekla-plugin-sdk 2026.0 surface of the Fusion.Models namespace — 11 types with full vendor-documented methods, properties, events, and behavioral remarks. Read when composing apps that touch any of: Entity, EntityGroup, EntityPickedCallbackDelegate, EntityPickingCallbackDelegate, EntityState, EntityStates, EntityType, Geometry, and 3 more types.
---

# Fusion.Models

Auto-generated from vendor docs for tekla-plugin-sdk 2026.0. 11 types in this namespace.
