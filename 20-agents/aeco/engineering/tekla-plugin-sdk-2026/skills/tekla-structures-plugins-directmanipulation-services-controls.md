...
description: This skill encodes the tekla-plugin-sdk 2026.0 surface of the Tekla.Structures.Plugins.DirectManipulation.Services.Controls namespace — 7 types with full vendor-documented methods, properties, events, and behavioral remarks. Read when composing apps that touch any of: ButtonControl, CheckBoxControl, DropDownListControl, LabelControl, RadioButtonControl, TextBoxControl, ValueBoxControl.
---
