...
description: This skill encodes the archicad 29.0 surface of the Tapir.AdditionalCommands namespace — 14 types with full vendor-documented methods, properties, events, and behavioral remarks. Read when composing apps that touch any of: ApplicationCommands, ProjectCommands, ElementCommands, ElementgroupingCommands, FavoritesCommands, PropertyCommands, AttributeCommands, LibraryCommands, and 6 more types.
---

# Tapir.AdditionalCommands

Auto-generated from vendor docs for archicad 29.0. 14 types in this namespace.
