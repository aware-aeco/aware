---
name: grasshopper-grasshopper-rhinoceros-render-params
description: This skill encodes the grasshopper 8.0 surface of the Grasshopper.Rhinoceros.Render.Params namespace — 5 types with full vendor-documented methods, properties, events, and behavioral remarks. Read when composing apps that touch any of: Param_ModelRenderTexture, Param_ModelRenderEnvironment, Param_ModelRenderMaterial, Param_ObjectRender, Param_ObjectRenderMaterial.
---
...
(No description provided in vendor docs for Grasshopper.Rhinoceros.Render.Params.Param_ModelRenderEnvironment.)

[Vendor docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/T_Grasshopper_Rhinoceros_Render_Params_Param_ModelRenderEnvironment.htm)

### Constructors
- `public Param_ModelRenderEnvironment()` — Initializes a new instance of the Param_ModelRenderEnvironment class
...
(No description provided in vendor docs for Grasshopper.Rhinoceros.Render.Params.Param_ModelRenderMaterial.)

[Vendor docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/T_Grasshopper_Rhinoceros_Render_Params_Param_ModelRenderMaterial.htm)

### Constructors
- `public Param_ModelRenderMaterial()` — Initializes a new instance of the Param_ModelRenderMaterial class
...
(No description provided in vendor docs for Grasshopper.Rhinoceros.Render.Params.Param_ModelRenderTexture.)

[Vendor docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/T_Grasshopper_Rhinoceros_Render_Params_Param_ModelRenderTexture.htm)

### Constructors
- `public Param_ModelRenderTexture()` — Initializes a new instance of the Param_ModelRenderTexture class
...
(No description provided in vendor docs for Grasshopper.Rhinoceros.Render.Params.Param_ObjectRender.)

[Vendor docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/T_Grasshopper_Rhinoceros_Render_Params_Param_ObjectRender.htm)

### Constructors
- `public Param_ObjectRender()` — Initializes a new instance of the Param_ObjectRender class
...
(No description provided in vendor docs for Grasshopper.Rhinoceros.Render.Params.Param_ObjectRenderMaterial.)

[Vendor docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/T_Grasshopper_Rhinoceros_Render_Params_Param_ObjectRenderMaterial.htm)

### Constructors
- `public Param_ObjectRenderMaterial()` — Initializes a new instance of the Param_ObjectRenderMaterial class
...
[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Rhinoceros_Render_Params_Param_ObjectRenderMaterial_ClearData.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Rhinoceros_Render_Params_Param_ObjectRenderMaterial_RegisterRemoteIDs.htm)
