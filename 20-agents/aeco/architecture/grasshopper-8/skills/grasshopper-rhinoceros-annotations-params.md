---
name: grasshopper-grasshopper-rhinoceros-annotations-params
description: This skill encodes the grasshopper 8.0 surface of the Grasshopper.Rhinoceros.Annotations.Params namespace — 9 types with full vendor-documented methods, properties, events, and behavioral remarks. Read when composing apps that touch any of: Param_AnnotationArrow, Param_AnnotationArrowSettings, Param_AnnotationDimensionSettings, Param_AnnotationLeaderSettings, Param_AnnotationTextSettings, Param_AnnotationToleranceSettings, Param_AnnotationUnitsSettings, Param_DateTimeFormat, and 1 more types.
---

# Grasshopper.Rhinoceros.Annotations.Params

Auto-generated from vendor docs for grasshopper 8.0. 9 types in this namespace.

## Param_AnnotationArrow (class)

(No description provided in vendor docs for Grasshopper.Rhinoceros.Annotations.Params.Param_AnnotationArrow.)

[Vendor docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/T_Grasshopper_Rhinoceros_Annotations_Params_Param_AnnotationArrow.htm)

### Constructors
- `public Param_AnnotationArrow()` — Initializes a new instance of the Param_AnnotationArrow class
...
(No description provided in vendor docs for Grasshopper.Rhinoceros.Annotations.Params.Param_AnnotationArrowSettings.)

[Vendor docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/T_Grasshopper_Rhinoceros_Annotations_Params_Param_AnnotationArrowSettings.htm)

### Constructors
- `public Param_AnnotationArrowSettings()` — Initializes a new instance of the Param_AnnotationArrowSettings class
...
(No description provided in vendor docs for Grasshopper.Rhinoceros.Annotations.Params.Param_AnnotationDimensionSettings.)

[Vendor docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/T_Grasshopper_Rhinoceros_Annotations_Params_Param_AnnotationDimensionSettings.htm)

### Constructors
- `public Param_AnnotationDimensionSettings()` — Initializes a new instance of the Param_AnnotationDimensionSettings class
...
(No description provided in vendor docs for Grasshopper.Rhinoceros.Annotations.Params.Param_AnnotationLeaderSettings.)

[Vendor docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/T_Grasshopper_Rhinoceros_Annotations_Params_Param_AnnotationLeaderSettings.htm)

### Constructors
- `public Param_AnnotationLeaderSettings()` — Initializes a new instance of the Param_AnnotationLeaderSettings class
...
(No description provided in vendor docs for Grasshopper.Rhinoceros.Annotations.Params.Param_AnnotationTextSettings.)

[Vendor docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/T_Grasshopper_Rhinoceros_Annotations_Params_Param_AnnotationTextSettings.htm)

### Constructors
- `public Param_AnnotationTextSettings()` — Initializes a new instance of the Param_AnnotationTextSettings class
...
(No description provided in vendor docs for Grasshopper.Rhinoceros.Annotations.Params.Param_AnnotationToleranceSettings.)

[Vendor docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/T_Grasshopper_Rhinoceros_Annotations_Params_Param_AnnotationToleranceSettings.htm)

### Constructors
- `public Param_AnnotationToleranceSettings()` — Initializes a new instance of the Param_AnnotationToleranceSettings class
...
(No description provided in vendor docs for Grasshopper.Rhinoceros.Annotations.Params.Param_AnnotationUnitsSettings.)

[Vendor docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/T_Grasshopper_Rhinoceros_Annotations_Params_Param_AnnotationUnitsSettings.htm)

### Constructors
- `public Param_AnnotationUnitsSettings()` — Initializes a new instance of the Param_AnnotationUnitsSettings class
...
(No description provided in vendor docs for Grasshopper.Rhinoceros.Annotations.Params.Param_DateTimeFormat.)

[Vendor docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/T_Grasshopper_Rhinoceros_Annotations_Params_Param_DateTimeFormat.htm)

### Constructors
- `public Param_DateTimeFormat()` — Initializes a new instance of the Param_DateTimeFormat class
...
(No description provided in vendor docs for Grasshopper.Rhinoceros.Annotations.Params.Param_ModelAnnotationStyle.)

[Vendor docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/T_Grasshopper_Rhinoceros_Annotations_Params_Param_ModelAnnotationStyle.htm)

### Constructors
- `public Param_ModelAnnotationStyle()` — Initializes a new instance of the Param_ModelAnnotationStyle class
