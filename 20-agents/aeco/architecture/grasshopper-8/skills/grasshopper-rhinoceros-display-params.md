---
name: grasshopper-grasshopper-rhinoceros-display-params
description: This skill encodes the grasshopper 8.0 surface of the Grasshopper.Rhinoceros.Display.Params namespace — 10 types with full vendor-documented methods, properties, events, and behavioral remarks. Read when composing apps that touch any of: Param_DisplayColorGradient, Param_DisplayColorStop, Param_ModelDisplayMode, Param_ModelPageViewport, Param_ModelStandardViewport, Param_ModelView, Param_ObjectDisplay, Param_ObjectDisplayColor, and 2 more types.
---

# Grasshopper.Rhinoceros.Display.Params

Auto-generated from vendor docs for grasshopper 8.0. 10 types in this namespace.

## Param_DisplayColorGradient (class)

(No description provided in vendor docs for Grasshopper.Rhinoceros.Display.Params.Param_DisplayColorGradient.)

[Vendor docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/T_Grasshopper_Rhinoceros_Display_Params_Param_DisplayColorGradient.htm)

### Constructors
- `public Param_DisplayColorGradient()` — Initializes a new instance of the Param_DisplayColorGradient class
...
[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Rhinoceros_Display_Params_Param_DisplayColorGradient_DrawViewportMeshes.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Rhinoceros_Display_Params_Param_DisplayColorGradient_DrawViewportWires.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Rhinoceros_Display_Params_Param_DisplayColorGradient_Menu_AppendPromptMore.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Rhinoceros_Display_Params_Param_DisplayColorGradient_Menu_AppendPromptOne.htm)
...
#### `protected override DisplayColorGradient PreferredCast(Object data)`
...
[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Rhinoceros_Display_Params_Param_DisplayColorGradient_PreferredCast.htm)
...
#### `protected override GH_GetterResult Prompt_Plural(ref List<DisplayColorGradient> values)`

(Overrides GH_PersistentParam<T>.Prompt_Plural(List<T>).)

**Parameters:**
- `values` (System.Collections.Generic.List<DisplayColorGradient>)

**Returns:** `GH_GetterResult` — 

[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Rhinoceros_Display_Params_Param_DisplayColorGradient_Prompt_Plural.htm)

#### `protected override GH_GetterResult Prompt_Singular(ref DisplayColorGradient value)`

(Overrides GH_PersistentParam<T>.Prompt_Singular(T).)

**Parameters:**
- `value` (Grasshopper.Rhinoceros.Display.DisplayColorGradient)

**Returns:** `GH_GetterResult` — 

[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Rhinoceros_Display_Params_Param_DisplayColorGradient_Prompt_Singular.htm)
...
(No description provided in vendor docs for Grasshopper.Rhinoceros.Display.Params.Param_DisplayColorStop.)

[Vendor docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/T_Grasshopper_Rhinoceros_Display_Params_Param_DisplayColorStop.htm)

### Constructors
- `public Param_DisplayColorStop()` — Initializes a new instance of the Param_DisplayColorStop class
...
[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Rhinoceros_Display_Params_Param_DisplayColorStop_Menu_AppendManageCollection.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Rhinoceros_Display_Params_Param_DisplayColorStop_Menu_AppendPromptMore.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Rhinoceros_Display_Params_Param_DisplayColorStop_Menu_AppendPromptOne.htm)
...
#### `protected override DisplayColorStop PreferredCast(Object data)`
...
[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Rhinoceros_Display_Params_Param_DisplayColorStop_PreferredCast.htm)
...
#### `protected override GH_GetterResult Prompt_Plural(ref List<DisplayColorStop> values)`

(Overrides GH_PersistentParam<T>.Prompt_Plural(List<T>).)

**Parameters:**
- `values` (System.Collections.Generic.List<DisplayColorStop>)

**Returns:** `GH_GetterResult` — 

[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Rhinoceros_Display_Params_Param_DisplayColorStop_Prompt_Plural.htm)

#### `protected override GH_GetterResult Prompt_Singular(ref DisplayColorStop value)`

(Overrides GH_PersistentParam<T>.Prompt_Singular(T).)

**Parameters:**
- `value` (Grasshopper.Rhinoceros.Display.DisplayColorStop)

**Returns:** `GH_GetterResult` — 

[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Rhinoceros_Display_Params_Param_DisplayColorStop_Prompt_Singular.htm)
...
(No description provided in vendor docs for Grasshopper.Rhinoceros.Display.Params.Param_ModelDisplayMode.)

[Vendor docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/T_Grasshopper_Rhinoceros_Display_Params_Param_ModelDisplayMode.htm)

### Constructors
- `public Param_ModelDisplayMode()` — Initializes a new instance of the Param_ModelDisplayMode class
...
(No description provided in vendor docs for Grasshopper.Rhinoceros.Display.Params.Param_ModelPageViewport.)

[Vendor docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/T_Grasshopper_Rhinoceros_Display_Params_Param_ModelPageViewport.htm)

### Constructors
- `public Param_ModelPageViewport()` — Initializes a new instance of the Param_ModelPageViewport class
...
(No description provided in vendor docs for Grasshopper.Rhinoceros.Display.Params.Param_ModelStandardViewport.)

[Vendor docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/T_Grasshopper_Rhinoceros_Display_Params_Param_ModelStandardViewport.htm)

### Constructors
- `public Param_ModelStandardViewport()` — Initializes a new instance of the Param_ModelStandardViewport class
...
(No description provided in vendor docs for Grasshopper.Rhinoceros.Display.Params.Param_ModelView.)

[Vendor docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/T_Grasshopper_Rhinoceros_Display_Params_Param_ModelView.htm)

### Constructors
- `public Param_ModelView()` — Initializes a new instance of the Param_ModelView class
...
[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Rhinoceros_Display_Params_Param_ModelView_BakeGeometry_1.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Rhinoceros_Display_Params_Param_ModelView_BakeGeometry.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Rhinoceros_Display_Params_Param_ModelView_DrawViewportMeshes.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Rhinoceros_Display_Params_Param_ModelView_DrawViewportWires.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Rhinoceros_Display_Params_Param_ModelView_HtmlHelp_Source.htm)

#### `protected override ModelView InstantiateT()`

(Overrides GH_Param<T>.InstantiateT().)

**Returns:** `ModelView` — 

[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Rhinoceros_Display_Params_Param_ModelView_InstantiateT.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Rhinoceros_Display_Params_Param_ModelView_Menu_AppendManageCollection.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Rhinoceros_Display_Params_Param_ModelView_Menu_AppendPromptMore.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Rhinoceros_Display_Params_Param_ModelView_Menu_AppendPromptOne.htm)
...
#### `protected override ModelView PreferredCast(Object data)`
...
[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Rhinoceros_Display_Params_Param_ModelView_PreferredCast.htm)
...
#### `protected override GH_GetterResult Prompt_Plural(ref List<ModelView> values)`

(Overrides GH_PersistentParam<T>.Prompt_Plural(List<T>).)

**Parameters:**
- `values` (System.Collections.Generic.List<ModelView>)

**Returns:** `GH_GetterResult` — 

[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Rhinoceros_Display_Params_Param_ModelView_Prompt_Plural.htm)

#### `protected override GH_GetterResult Prompt_Singular(ref ModelView value)`

(Overrides GH_PersistentParam<T>.Prompt_Singular(T).)

**Parameters:**
- `value` (Grasshopper.Rhinoceros.Display.ModelView)

**Returns:** `GH_GetterResult` — 

[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Rhinoceros_Display_Params_Param_ModelView_Prompt_Singular.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Rhinoceros_Display_Params_Param_ModelView_Read.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Rhinoceros_Display_Params_Param_ModelView_Write.htm)
...
(No description provided in vendor docs for Grasshopper.Rhinoceros.Display.Params.Param_ObjectDisplay.)

[Vendor docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/T_Grasshopper_Rhinoceros_Display_Params_Param_ObjectDisplay.htm)

### Constructors
- `public Param_ObjectDisplay()` — Initializes a new instance of the Param_ObjectDisplay class
...
- `SubCategory` (String, get/set) — Gets or sets the SubCategory in which this object belongs. If HasSubCategory() returns false, this field has no meaning.
- `Type` (Type, get) — Gets the Framework Type descriptor for the stored Data.
- `TypeName` (String, get) — (Inherited from ModelDataParam<T>.)
- `VolatileData` (IGH_Structure, get) — (Inherited from GH_Param<T>.)
- `VolatileDataCount` (Int32, get) — (Inherited from GH_Param<T>.)
- `WireDisplay` (GH_ParamWireDisplay, get/set) — Gets or sets the wire display style for this parameter. Wire display only affects the wires connected to the parameter input.
...
(No description provided in vendor docs for Grasshopper.Rhinoceros.Display.Params.Param_ObjectDisplayColor.)

[Vendor docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/T_Grasshopper_Rhinoceros_Display_Params_Param_ObjectDisplayColor.htm)

### Constructors
- `public Param_ObjectDisplayColor()` — Initializes a new instance of the Param_ObjectDisplayColor class
...
(No description provided in vendor docs for Grasshopper.Rhinoceros.Display.Params.Param_ObjectDisplayMode.)

[Vendor docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/T_Grasshopper_Rhinoceros_Display_Params_Param_ObjectDisplayMode.htm)

### Constructors
- `public Param_ObjectDisplayMode()` — Initializes a new instance of the Param_ObjectDisplayMode class
...
(No description provided in vendor docs for Grasshopper.Rhinoceros.Display.Params.Param_ObjectVisibility.)

[Vendor docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/T_Grasshopper_Rhinoceros_Display_Params_Param_ObjectVisibility.htm)

### Constructors
- `public Param_ObjectVisibility()` — Initializes a new instance of the Param_ObjectVisibility class
