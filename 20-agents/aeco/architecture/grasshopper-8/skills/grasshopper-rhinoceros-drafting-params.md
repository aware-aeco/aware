---
name: grasshopper-grasshopper-rhinoceros-drafting-params
description: This skill encodes the grasshopper 8.0 surface of the Grasshopper.Rhinoceros.Drafting.Params namespace — 8 types with full vendor-documented methods, properties, events, and behavioral remarks. Read when composing apps that touch any of: Param_ModelHatchLine, Param_ModelHatchPattern, Param_ModelLinetype, Param_ModelLineWidth, Param_ObjectDrafting, Param_ObjectDraftingLinetype, Param_ObjectDraftingColor, Param_ObjectDraftingLineWidth.
---
...
(No description provided in vendor docs for Grasshopper.Rhinoceros.Drafting.Params.Param_ModelHatchLine.)

[Vendor docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/T_Grasshopper_Rhinoceros_Drafting_Params_Param_ModelHatchLine.htm)

### Constructors
- `public Param_ModelHatchLine()` — Initializes a new instance of the Param_ModelHatchLine class
...
(No description provided in vendor docs for Grasshopper.Rhinoceros.Drafting.Params.Param_ModelHatchPattern.)

[Vendor docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/T_Grasshopper_Rhinoceros_Drafting_Params_Param_ModelHatchPattern.htm)

### Constructors
- `public Param_ModelHatchPattern()` — Initializes a new instance of the Param_ModelHatchPattern class
...
(No description provided in vendor docs for Grasshopper.Rhinoceros.Drafting.Params.Param_ModelLineWidth.)

[Vendor docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/T_Grasshopper_Rhinoceros_Drafting_Params_Param_ModelLineWidth.htm)

### Constructors
- `public Param_ModelLineWidth()` — Initializes a new instance of the Param_ModelLineWidth class
...
(No description provided in vendor docs for Grasshopper.Rhinoceros.Drafting.Params.Param_ModelLinetype.)

[Vendor docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/T_Grasshopper_Rhinoceros_Drafting_Params_Param_ModelLinetype.htm)

### Constructors
- `public Param_ModelLinetype()` — Initializes a new instance of the Param_ModelLinetype class
...
(No description provided in vendor docs for Grasshopper.Rhinoceros.Drafting.Params.Param_ObjectDrafting.)

[Vendor docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/T_Grasshopper_Rhinoceros_Drafting_Params_Param_ObjectDrafting.htm)

### Constructors
- `public Param_ObjectDrafting()` — Initializes a new instance of the Param_ObjectDrafting class
...
(No description provided in vendor docs for Grasshopper.Rhinoceros.Drafting.Params.Param_ObjectDraftingColor.)

[Vendor docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/T_Grasshopper_Rhinoceros_Drafting_Params_Param_ObjectDraftingColor.htm)

### Constructors
- `public Param_ObjectDraftingColor()` — Initializes a new instance of the Param_ObjectDraftingColor class
...
(No description provided in vendor docs for Grasshopper.Rhinoceros.Drafting.Params.Param_ObjectDraftingLineWidth.)

[Vendor docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/T_Grasshopper_Rhinoceros_Drafting_Params_Param_ObjectDraftingLineWidth.htm)

### Constructors
- `public Param_ObjectDraftingLineWidth()` — Initializes a new instance of the Param_ObjectDraftingLineWidth class
...
(No description provided in vendor docs for Grasshopper.Rhinoceros.Drafting.Params.Param_ObjectDraftingLinetype.)

[Vendor docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/T_Grasshopper_Rhinoceros_Drafting_Params_Param_ObjectDraftingLinetype.htm)

### Constructors
- `public Param_ObjectDraftingLinetype()` — Initializes a new instance of the Param_ObjectDraftingLinetype class
...
(Overrides GH_Param<T>.ClearData().)

[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Rhinoceros_Drafting_Params_Param_ObjectDraftingLinetype_ClearData.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Rhinoceros_Drafting_Params_Param_ObjectDraftingLinetype_RegisterRemoteIDs.htm)
