---
name: grasshopper-grasshopper-rhinoceros-params
description: This skill encodes the grasshopper 8.0 surface of the Grasshopper.Rhinoceros.Params namespace — 8 types with full vendor-documented methods, properties, events, and behavioral remarks. Read when composing apps that touch any of: ModelContentParam<T>, ModelDataParam<T>, Param_MatchText, Param_ModelAttributeKey, Param_ModelFont, Param_ModelContent, Param_ModelMeshingParameters, Param_ModelUnitSystem.
---
...
(No description provided in vendor docs for Grasshopper.Rhinoceros.Params.ModelContentParam<T>.)

[Vendor docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/T_Grasshopper_Rhinoceros_Params_ModelContentParam_1.htm)

### Constructors
- `protected ModelContentParam(GH_InstanceDescription nTag)` — Initializes a new instance of the ModelContentParam<T> class
...
#### `protected override T InstantiateT()`

(Inherited from GH_PersistentReferenceParam<T>.)

**Returns:** `T` — 

[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Kernel_GH_PersistentReferenceParam_1_InstantiateT.htm)
...
(Overrides GH_PersistentParam<T>.Menu_AppendInternaliseData(ToolStripDropDown).)

**Parameters:**
- `menu` (System.Windows.Forms.ToolStripDropDown)

[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Rhinoceros_Params_ModelContentParam_1_Menu_AppendInternaliseData.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Rhinoceros_Params_ModelContentParam_1_Menu_AppendPromptMore.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Rhinoceros_Params_ModelContentParam_1_Menu_AppendPromptOne.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Kernel_GH_PersistentReferenceParam_1_OnVolatileDataCollected.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Kernel_GH_PersistentParam_1_Prompt_Plural.htm)

#### `protected abstract GH_GetterResult Prompt_Singular(ref T value)`
...
[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Kernel_GH_PersistentParam_1_Prompt_Singular.htm)
...
(Overrides GH_ActiveObject.RegisterRemoteIDs(GH_GuidTable).)
...
#### `protected IEnumerable<T> SelectedContent(IEnumerable<T> items)`
...
[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Rhinoceros_Params_ModelContentParam_1_SelectedContent.htm)
...
- `ComponentGuid` (Guid, get) — Returns a consistent ID for this object type. Every object must supply a unique and unchanging ID that is used to identify objects of the same type.
...
- `Exposure` (GH_Exposure, get) — Gets the exposure of this object in the Graphical User Interface. The default is to expose everywhere.
...
- `Icon` (Bitmap, get) — (Inherited from GH_PersistentReferenceParam<T>.)
...
(No description provided in vendor docs for Grasshopper.Rhinoceros.Params.ModelDataParam<T>.)

[Vendor docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/T_Grasshopper_Rhinoceros_Params_ModelDataParam_1.htm)

### Constructors
- `protected ModelDataParam(GH_InstanceDescription nTag)` — Initializes a new instance of the ModelDataParam<T> class
...
[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Kernel_GH_Param_1_AppendAdditionalMenuItems.htm)
...
#### `protected virtual void CollectVolatileData_Custom()`
...
[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Kernel_GH_Param_1_CollectVolatileData_Custom.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Rhinoceros_Params_ModelDataParam_1_InstantiateT.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Kernel_GH_Param_1_Read.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Kernel_GH_Param_1_Write.htm)
...
- `SubCategory` (String, get/set) — Gets or sets the SubCategory in which this object belongs. If HasSubCategory() returns false, this field has no meaning.
- `Type` (Type, get) — Gets the Framework Type descriptor for the stored Data.
- `TypeName` (String, get) — (Overrides GH_Param<T>.TypeName.)
- `VolatileData` (IGH_Structure, get) — (Inherited from GH_Param<T>.)
- `VolatileDataCount` (Int32, get) — (Inherited from GH_Param<T>.)
- `WireDisplay` (GH_ParamWireDisplay, get/set) — Gets or sets the wire display style for this parameter. Wire display only affects the wires connected to the parameter input.
- `m_attributes` (IGH_Attributes, get) — (Inherited from GH_DocumentObject.)
...
(No description provided in vendor docs for Grasshopper.Rhinoceros.Params.Param_MatchText.)

[Vendor docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/T_Grasshopper_Rhinoceros_Params_Param_MatchText.htm)

### Constructors
- `public Param_MatchText()` — Initializes a new instance of the Param_MatchText class
...
(Overrides GH_PersistentParam<T>.AppendAdditionalMenuItems(ToolStripDropDown).)

**Parameters:**
- `menu` (System.Windows.Forms.ToolStripDropDown)

[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Rhinoceros_Params_Param_MatchText_AppendAdditionalMenuItems.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Rhinoceros_Params_Param_MatchText_InstantiateT.htm)
...
#### `public bool MatchText(string value, string pattern, bool ignoreCase, CultureInfo culture)`
...
[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Rhinoceros_Params_Param_MatchText_MatchText.htm)
...
(Overrides GH_PersistentParam<T>.Menu_CustomMultiValueItem().)

**Returns:** `ToolStripMenuItem` — 

[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Rhinoceros_Params_Param_MatchText_Menu_CustomMultiValueItem.htm)

#### `protected override ToolStripMenuItem Menu_CustomSingleValueItem()`

(Overrides GH_PersistentParam<T>.Menu_CustomSingleValueItem().)

**Returns:** `ToolStripMenuItem` — 

[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Rhinoceros_Params_Param_MatchText_Menu_CustomSingleValueItem.htm)
...
**Parameters:**
- `sender` (Grasshopper.GUI.GH_MenuTextBox)
- `e` (System.Windows.Forms.KeyEventArgs)

[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Rhinoceros_Params_Param_MatchText_Menu_SingleStringValueKeyDown.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Rhinoceros_Params_Param_MatchText_PreferredCast.htm)
...
**Parameters:**
- `value` (System.Collections.Generic.List<GH_String>)

**Returns:** `GH_GetterResult` — 

[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Rhinoceros_Params_Param_MatchText_Prompt_Plural.htm)
...
**Parameters:**
- `value` (Grasshopper.Kernel.Types.GH_String)

**Returns:** `GH_GetterResult` — 

[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Rhinoceros_Params_Param_MatchText_Prompt_Singular.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Rhinoceros_Params_Param_MatchText_Read.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Rhinoceros_Params_Param_MatchText_RemoveEffects.htm)
...
(Overrides GH_PersistentParam<T>.Write(GH_IWriter).)
...
[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Rhinoceros_Params_Param_MatchText_Write.htm)
...
- `Kind` (GH_ParamKind, get) — Gets the parameter kind. The kind is evaluated lazily and cached.
- `Locked` (Boolean, get/set) — Gets or sets the enabled flag of this object. Disabled objects are ignored during solutions.
- `MatchingMode` (GH_PatternMatching.MatchingMode, get/set) — 
- `MutableNickName` (Boolean, get/set) — Gets or sets a value that enables Nick name changes through the menu. The default is TRUE.
- `Name` (String, get/set) — Gets or sets the name of the object. This field typically remains fixed during the lifetime of an object.
...
(No description provided in vendor docs for Grasshopper.Rhinoceros.Params.Param_ModelAttributeKey.)

[Vendor docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/T_Grasshopper_Rhinoceros_Params_Param_ModelAttributeKey.htm)

### Constructors
- `public Param_ModelAttributeKey()` — Initializes a new instance of the Param_ModelAttributeKey class
...
(Overrides GH_DocumentObject.AddedToDocument(GH_Document).)

**Parameters:**
- `document` (Grasshopper.Kernel.GH_Document)

[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Rhinoceros_Params_Param_ModelAttributeKey_AddedToDocument.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Rhinoceros_Params_Param_ModelAttributeKey_Read.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Rhinoceros_Params_Param_ModelAttributeKey_Write.htm)
...
(No description provided in vendor docs for Grasshopper.Rhinoceros.Params.Param_ModelContent.)

[Vendor docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/T_Grasshopper_Rhinoceros_Params_Param_ModelContent.htm)

### Constructors
- `public Param_ModelContent()` — Initializes a new instance of the Param_ModelContent class
...
- `SubCategory` (String, get/set) — Gets or sets the SubCategory in which this object belongs. If HasSubCategory() returns false, this field has no meaning.
- `Type` (Type, get) — Gets the Framework Type descriptor for the stored Data.
- `TypeName` (String, get) — (Overrides GH_PersistentReferenceParam<T>.TypeName.)
- `VolatileData` (IGH_Structure, get) — (Inherited from GH_Param<T>.)
- `VolatileDataCount` (Int32, get) — (Inherited from GH_Param<T>.)
- `WireDisplay` (GH_ParamWireDisplay, get/set) — Gets or sets the wire display style for this parameter. Wire display only affects the wires connected to the parameter input.
...
(No description provided in vendor docs for Grasshopper.Rhinoceros.Params.Param_ModelFont.)

[Vendor docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/T_Grasshopper_Rhinoceros_Params_Param_ModelFont.htm)

### Constructors
- `public Param_ModelFont()` — Initializes a new instance of the Param_ModelFont class
...
[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Rhinoceros_Params_Param_ModelFont_Menu_AppendManageCollection.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Rhinoceros_Params_Param_ModelFont_Menu_AppendPromptMore.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Rhinoceros_Params_Param_ModelFont_Menu_AppendPromptOne.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Rhinoceros_Params_Param_ModelFont_Menu_CustomMultiValueItem.htm)
...
#### `protected override ModelFont PreferredCast(Object data)`
...
[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Rhinoceros_Params_Param_ModelFont_PreferredCast.htm)
...
#### `protected override GH_GetterResult Prompt_Plural(ref List<ModelFont> values)`

(Overrides GH_PersistentParam<T>.Prompt_Plural(List<T>).)

**Parameters:**
- `values` (System.Collections.Generic.List<ModelFont>)

**Returns:** `GH_GetterResult` — 

[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Rhinoceros_Params_Param_ModelFont_Prompt_Plural.htm)

#### `protected override GH_GetterResult Prompt_Singular(ref ModelFont value)`

(Overrides GH_PersistentParam<T>.Prompt_Singular(T).)

**Parameters:**
- `value` (Grasshopper.Rhinoceros.ModelFont)

**Returns:** `GH_GetterResult` — 

[Docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/M_Grasshopper_Rhinoceros_Params_Param_ModelFont_Prompt_Singular.htm)
...
(No description provided in vendor docs for Grasshopper.Rhinoceros.Params.Param_ModelMeshingParameters.)

[Vendor docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/T_Grasshopper_Rhinoceros_Params_Param_ModelMeshingParameters.htm)

### Constructors
- `public Param_ModelMeshingParameters()` — Initializes a new instance of the Param_ModelMeshingParameters class
...
(No description provided in vendor docs for Grasshopper.Rhinoceros.Params.Param_ModelUnitSystem.)

[Vendor docs](https://raw.githubusercontent.com/mcneel/grasshopper-api-docs/gh-pages/api/grasshopper/html/T_Grasshopper_Rhinoceros_Params_Param_ModelUnitSystem.htm)

### Constructors
- `public Param_ModelUnitSystem()` — Initializes a new instance of the Param_ModelUnitSystem class
...
- `VolatileDataCount` (Int32, get) — (Inherited from GH_Param<T>.)
- `WireDisplay` (GH_ParamWireDisplay, get/set) — Gets or sets the wire display style for this parameter. Wire display only affects the wires connected to the parameter input.
- `Values` (IEnumerable<ModelUnitSystem>, get) — 
