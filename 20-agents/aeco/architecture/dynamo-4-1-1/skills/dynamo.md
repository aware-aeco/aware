---
name: dynamo-dynamo
description: This skill encodes the dynamo 4.1.1 surface of the Dynamo namespace — 2 types with full vendor-documented methods, properties, events, and behavioral remarks. Read when composing apps that touch any of: CustomNodeDefinition, CustomNodeInfo.
---
...
[Vendor docs](https://github.com/DynamoDS/Dynamo/blob/RC4.1.1_master/src/DynamoCore/Core/CustomNodeDefinition.cs)
