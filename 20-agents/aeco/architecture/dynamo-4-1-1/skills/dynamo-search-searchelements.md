...
description: This skill encodes the dynamo 4.1.1 surface of the Dynamo.Search.SearchElements namespace — 11 types with full vendor-documented methods, properties, events, and behavioral remarks. Read when composing apps that touch any of: CodeBlockNodeSearchElement, CustomNodeSearchElement, NodeModelSearchElement, NodeModelSearchElementBase, NodeSearchElement, AutoCompletionNodeMachineLearningInfo, DragDropNodeSearchElementInfo, SearchElementBase, and 3 more types.
---
...
[Vendor docs](https://github.com/DynamoDS/Dynamo/blob/RC4.1.1_master/src/DynamoCore/Search/SearchElements/NodeSearchElement.cs)
...
[Vendor docs](https://github.com/DynamoDS/Dynamo/blob/RC4.1.1_master/src/DynamoCore/Search/SearchElements/CodeBlockNodeSearchElement.cs)
...
[Docs](https://github.com/DynamoDS/Dynamo/blob/RC4.1.1_master/src/DynamoCore/Search/SearchElements/CodeBlockNodeSearchElement.cs)

## CustomNodeSearchElement (class)

Search element for custom nodes.

[Vendor docs](https://github.com/DynamoDS/Dynamo/blob/RC4.1.1_master/src/DynamoCore/Search/SearchElements/CustomNodeSearchElement.cs)
...
[Docs](https://github.com/DynamoDS/Dynamo/blob/RC4.1.1_master/src/DynamoCore/Search/SearchElements/CustomNodeSearchElement.cs)
...
[Vendor docs](https://github.com/DynamoDS/Dynamo/blob/RC4.1.1_master/src/DynamoCore/Search/SearchElements/SearchElementGroup.cs)
...
[Vendor docs](https://github.com/DynamoDS/Dynamo/blob/RC4.1.1_master/src/DynamoCore/Search/SearchElements/NodeModelSearchElement.cs)
...
[Docs](https://github.com/DynamoDS/Dynamo/blob/RC4.1.1_master/src/DynamoCore/Search/SearchElements/NodeModelSearchElement.cs)
...
[Vendor docs](https://github.com/DynamoDS/Dynamo/blob/RC4.1.1_master/src/DynamoCore/Search/SearchElements/NodeModelSearchElementBase.cs)
...
[Docs](https://github.com/DynamoDS/Dynamo/blob/RC4.1.1_master/src/DynamoCore/Search/SearchElements/NodeSearchElement.cs)
...
[Vendor docs](https://github.com/DynamoDS/Dynamo/blob/RC4.1.1_master/src/DynamoCore/Search/SearchElements/ZeroTouchSearchElement.cs)
...
[Docs](https://github.com/DynamoDS/Dynamo/blob/RC4.1.1_master/src/DynamoCore/Search/SearchElements/ZeroTouchSearchElement.cs)
