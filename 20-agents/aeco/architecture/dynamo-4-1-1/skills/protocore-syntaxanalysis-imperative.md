---
name: dynamo-protocore-syntaxanalysis-imperative
description: This skill encodes the dynamo 4.1.1 surface of the ProtoCore.SyntaxAnalysis.Imperative namespace — 1 types with full vendor-documented methods, properties, events, and behavioral remarks. Read when composing apps that touch any of: IAstVisitor<TResult>.
---

# ProtoCore.SyntaxAnalysis.Imperative
...
[Vendor docs](https://github.com/DynamoDS/Dynamo/blob/RC4.1.1_master/src/Engine/ProtoCore/SyntaxAnalysis/Interface/Associative.cs)
...
[Docs](https://github.com/DynamoDS/Dynamo/blob/RC4.1.1_master/src/Engine/ProtoCore/SyntaxAnalysis/Interface/Associative.cs)
...
IAstVisitor.VisitIfStatementNode
...
IAstVisitor.VisitIfStmtPositionNode
...
IAstVisitor.VisitWhileStatementNode
