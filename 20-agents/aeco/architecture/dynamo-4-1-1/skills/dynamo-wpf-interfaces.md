...
description: This skill encodes the dynamo 4.1.1 surface of the Dynamo.Wpf.Interfaces namespace — 6 types with full vendor-documented methods, properties, events, and behavioral remarks. Read when composing apps that touch any of: ILibraryViewCustomization, LayoutSpecification, LayoutIncludeInfo, LayoutElementType, LayoutElement, LayoutSection.
---
...
[Vendor docs](https://github.com/DynamoDS/Dynamo/blob/RC4.1.1_master/src/DynamoCore/Interfaces/ILibraryViewCustomization.cs)
...
[Docs](https://github.com/DynamoDS/Dynamo/blob/RC4.1.1_master/src/DynamoCore/Interfaces/ILibraryViewCustomization.cs)
...
[Vendor docs](https://github.com/DynamoDS/Dynamo/blob/RC4.1.1_master/src/DynamoCore/Interfaces/LayoutSpecification.cs)
...
[Docs](https://github.com/DynamoDS/Dynamo/blob/RC4.1.1_master/src/DynamoCore/Interfaces/LayoutSpecification.cs)
