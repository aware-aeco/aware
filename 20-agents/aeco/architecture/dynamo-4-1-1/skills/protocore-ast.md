...
description: This skill encodes the dynamo 4.1.1 surface of the ProtoCore.AST namespace — 3 types with full vendor-documented methods, properties, events, and behavioral remarks. Read when composing apps that touch any of: Node, DictionaryExpressionBuilderBase<T>, NodeEnumerableExtensions.
---
...
[Vendor docs](https://github.com/DynamoDS/Dynamo/blob/RC4.1.1_master/src/Engine/ProtoCore/Parser/AST.cs)
...
[Docs](https://github.com/DynamoDS/Dynamo/blob/RC4.1.1_master/src/Engine/ProtoCore/Parser/AST.cs)
...
[Vendor docs](https://github.com/DynamoDS/Dynamo/blob/RC4.1.1_master/src/Engine/ProtoCore/Parser/ImperativeAST.cs)
...
[Docs](https://github.com/DynamoDS/Dynamo/blob/RC4.1.1_master/src/Engine/ProtoCore/Parser/ImperativeAST.cs)
