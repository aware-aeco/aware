...
description: This skill encodes the dynamo 4.1.1 surface of the ProtoCore.AssociativeEngine namespace — 1 types with full vendor-documented methods, properties, events, and behavioral remarks. Read when composing apps that touch any of: Utils.
---
...
[Vendor docs](https://github.com/DynamoDS/Dynamo/blob/RC4.1.1_master/src/Engine/ProtoCore/AssociativeGraph.cs)
...
[Docs](https://github.com/DynamoDS/Dynamo/blob/RC4.1.1_master/src/Engine/ProtoCore/AssociativeGraph.cs)
