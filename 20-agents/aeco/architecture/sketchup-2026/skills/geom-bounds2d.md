...
- `set!` — The #set! method is used to update the dimensions and position of a Geom::Bounds2d object so that it matches the specified bounds. The argument is anything that can be converted into a Geom::Bounds2d.
- `to_a` — The #to_a method returns an array which contains the Point2ds that define the Geom::Bounds2d.
