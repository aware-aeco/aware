...
- `scale_factor` — The #scale_factor method returns the scale factor associated with the Layout::Group.
...
- `scale_units=` — The #scale_units= method sets the units format for the scale of the Layout::Group.
- `set_scale_factor` — The #set_scale_factor method sets the scale factor for the Layout::Group.
