...
- `attribute_dictionary` — The #attribute_dictionary method returns a copy of the document's attribute dictionary with the given name.
- `auto_text_definitions` — The #auto_text_definitions method returns an array of AutoTextDefinition's in the Layout::Document.
- `delete_attribute` — The #delete_attribute method is used to delete an attribute from a document.
...
- `get_attribute` — The #get_attribute method is used to retrieve the value of an attribute in the document's attribute dictionary.
...
- `set_attribute` — The #set_attribute method adds an attribute to the document's attribute dictionary.
