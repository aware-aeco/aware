...
- `name=` — The name= method sets the name for a page's tab.
- `rendering_options` — The rendering_options method retrieves a RenderingOptions object for the page.
...
- `shadow_info` — The #shadow_info method retrieves the ShadowInfo object for the page.
