...
description: This skill encodes the dynamo 4.1.0 surface of the Dynamo.Visualization namespace — 5 types with full vendor-documented methods, properties, events, and behavioral remarks. Read when composing apps that touch any of: DefaultRenderPackageFactory, DefaultRenderPackage, IRenderPackageFactory, IRenderPackageSource<T>, RenderPackageCache.
---
...
[Vendor docs](https://github.com/DynamoDS/Dynamo/blob/v4.1.0/src/DynamoCore/Visualization/DefaultRenderPackageFactory.cs)
...
[Docs](https://github.com/DynamoDS/Dynamo/blob/v4.1.0/src/DynamoCore/Visualization/DefaultRenderPackageFactory.cs)
...
[Vendor docs](https://github.com/DynamoDS/Dynamo/blob/v4.1.0/src/DynamoCore/Visualization/IRenderPackageFactory.cs)
...
[Docs](https://github.com/DynamoDS/Dynamo/blob/v4.1.0/src/DynamoCore/Visualization/IRenderPackageFactory.cs)
...
[Vendor docs](https://github.com/DynamoDS/Dynamo/blob/v4.1.0/src/DynamoCore/Visualization/IRenderPackageSource.cs)
...
[Docs](https://github.com/DynamoDS/Dynamo/blob/v4.1.0/src/DynamoCore/Visualization/IRenderPackageSource.cs)

## RenderPackageCache (class)

This class controls the collection and distribution of render packages

[Vendor docs](https://github.com/DynamoDS/Dynamo/blob/v4.1.0/src/DynamoCore/Visualization/RenderPackageCache.cs)
...
[Docs](https://github.com/DynamoDS/Dynamo/blob/v4.1.0/src/DynamoCore/Visualization/RenderPackageCache.cs)
