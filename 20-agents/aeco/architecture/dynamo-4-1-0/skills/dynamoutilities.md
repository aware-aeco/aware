...
description: This skill encodes the dynamo 4.1.0 surface of the DynamoUtilities namespace — 6 types with full vendor-documented methods, properties, events, and behavioral remarks. Read when composing apps that touch any of: CertificateVerification, PathHelper, SmartObservableCollection<T>, StringUtilities, TypeSwitch, XmlHelper.
---
...
[Vendor docs](https://github.com/DynamoDS/Dynamo/blob/v4.1.0/src/DynamoUtilities/PathHelper.cs)
...
[Docs](https://github.com/DynamoDS/Dynamo/blob/v4.1.0/src/DynamoUtilities/PathHelper.cs)
...
[Vendor docs](https://github.com/DynamoDS/Dynamo/blob/v4.1.0/src/DynamoUtilities/SmartObservableCollection.cs)
...
[Docs](https://github.com/DynamoDS/Dynamo/blob/v4.1.0/src/DynamoUtilities/SmartObservableCollection.cs)
...
[Vendor docs](https://github.com/DynamoDS/Dynamo/blob/v4.1.0/src/DynamoUtilities/StringUtilities.cs)
...
[Docs](https://github.com/DynamoDS/Dynamo/blob/v4.1.0/src/DynamoUtilities/StringUtilities.cs)
...
[Docs](https://github.com/DynamoDS/Dynamo/blob/v4.1.0/src/DynamoUtilities/TypeSwitch.cs)
...
[Vendor docs](https://github.com/DynamoDS/Dynamo/blob/v4.1.0/src/DynamoUtilities/XmlHelper.cs)
...
[Docs](https://github.com/DynamoDS/Dynamo/blob/v4.1.0/src/DynamoUtilities/XmlHelper.cs)
