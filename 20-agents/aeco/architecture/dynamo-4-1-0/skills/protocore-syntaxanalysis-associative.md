---
name: dynamo-protocore-syntaxanalysis-associative
description: This skill encodes the dynamo 4.1.0 surface of the ProtoCore.SyntaxAnalysis.Associative namespace — 1 types with full vendor-documented methods, properties, events, and behavioral remarks. Read when composing apps that touch any of: IAstVisitor<TResult>.
---

# ProtoCore.SyntaxAnalysis.Associative

Auto-generated from vendor docs for dynamo 4.1.0. 1 types in this namespace.

## IAstVisitor<TResult> (interface)

Type IAstVisitor<TResult>

[Vendor docs](https://github.com/DynamoDS/Dynamo/blob/v4.1.0/src/Engine/ProtoCore/SyntaxAnalysis/Interface/Associative.cs)

### Methods
#### `TResult VisitArgumentSignatureNode(ProtoCore.AST.AssociativeAST.ArgumentSignatureNode node)`

IAstVisitor.VisitArgumentSignatureNode
...
[Docs](https://github.com/DynamoDS/Dynamo/blob/v4.1.0/src/Engine/ProtoCore/SyntaxAnalysis/Interface/Associative.cs)

#### `TResult VisitArrayNameNode(ProtoCore.AST.AssociativeAST.ArrayNameNode node)`

IAstVisitor.VisitArrayNameNode
...
IAstVisitor.VisitBinaryExpressionNode
...
IAstVisitor.VisitClassDeclNode
...
IAstVisitor.VisitCodeBlockNode
...
IAstVisitor.VisitConstructorDefinitionNode
...
IAstVisitor.VisitDefaultArgNode
...
IAstVisitor.VisitDynamicBlockNode
...
IAstVisitor.VisitFunctionCallNode
...
IAstVisitor.VisitFunctionDefinitionNode
...
IAstVisitor.VisitFunctionDotCallNode
...
IAstVisitor.VisitGroupExpressionNode
...
IAstVisitor.VisitIdentifierListNode
...
IAstVisitor.VisitIdentifierNode
...
IAstVisitor.VisitInlineConditionalNode
...
IAstVisitor.VisitLanguageBlockNode
...
IAstVisitor.VisitRangeExprNode
...
IAstVisitor.VisitReplicationGuideNode
...
IAstVisitor.VisitThisPointerNode
...
IAstVisitor.VisitTypedIdentifierNode
...
IAstVisitor.VisitUnaryExpressionNode
