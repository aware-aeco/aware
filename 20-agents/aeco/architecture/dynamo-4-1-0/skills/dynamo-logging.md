...
description: This skill encodes the dynamo 4.1.0 surface of the Dynamo.Logging namespace — 11 types with full vendor-documented methods, properties, events, and behavioral remarks. Read when composing apps that touch any of: LogLevel, WarningLevel, LogEventHandler, LogEventArgs, DynamoLogger, ILogger, ILogMessage, ILogSource, and 3 more types.
---
...
[Vendor docs](https://github.com/DynamoDS/Dynamo/blob/v4.1.0/src/DynamoCore/Logging/DynamoLogger.cs)
...
[Docs](https://github.com/DynamoDS/Dynamo/blob/v4.1.0/src/DynamoCore/Logging/DynamoLogger.cs)
...
[Vendor docs](https://github.com/DynamoDS/Dynamo/blob/v4.1.0/src/DynamoCore/Logging/ILogger.cs)
...
[Docs](https://github.com/DynamoDS/Dynamo/blob/v4.1.0/src/DynamoCore/Logging/ILogger.cs)
...
[Vendor docs](https://github.com/DynamoDS/Dynamo/blob/v4.1.0/src/DynamoCore/Logging/LogMessage.cs)
...
[Docs](https://github.com/DynamoDS/Dynamo/blob/v4.1.0/src/DynamoCore/Logging/LogMessage.cs)
...
[Vendor docs](https://github.com/DynamoDS/Dynamo/blob/v4.1.0/src/DynamoCore/Logging/LogSource.cs)
...
[Docs](https://github.com/DynamoDS/Dynamo/blob/v4.1.0/src/DynamoCore/Logging/LogSource.cs)
...
[Vendor docs](https://github.com/DynamoDS/Dynamo/blob/v4.1.0/src/DynamoCore/Logging/NotificationMessage.cs)
