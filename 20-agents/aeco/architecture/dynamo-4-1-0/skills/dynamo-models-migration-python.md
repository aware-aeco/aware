...
description: This skill encodes the dynamo 4.1.0 surface of the Dynamo.Models.Migration.Python namespace — 1 types with full vendor-documented methods, properties, events, and behavioral remarks. Read when composing apps that touch any of: PythonEngineUpgradeService.
---
...
[Docs](https://github.com/DynamoDS/Dynamo/blob/v4.1.0/src/DynamoCore/Migration/PythonEngineUpgradeService.cs)
