---
name: dynamo-
description: This skill encodes the dynamo 4.1.0 surface of the  namespace — 98 types with full vendor-documented methods, properties, events, and behavioral remarks. Read when composing apps that touch any of: CommandLineArguments, LuceneStorage, BrowserItemHandler, SearchElementHandler, TaskPriority, TaskMergeInstruction, State, Decision, and 90 more types.
---

# 

Auto-generated from vendor docs for dynamo 4.1.0. 98 types in this namespace.

## ASC_STATUS (enum)

Type ASC_STATUS

[Vendor docs](https://github.com/DynamoDS/Dynamo/blob/v4.1.0/src/Tools/DynamoInstallDetective/AscSDKWrapper.cs)
...
[Vendor docs](https://github.com/DynamoDS/Dynamo/blob/v4.1.0/src/DynamoUtilities/CertificateVerification.cs)
...
[Vendor docs](https://github.com/DynamoDS/Dynamo/blob/v4.1.0/src/DynamoUtilities/TypeSwitch.cs)
...
[Vendor docs](https://github.com/DynamoDS/Dynamo/blob/v4.1.0/src/DynamoCore/Engine/CodeCompletion/CodeCompletionServices.cs)
...
[Vendor docs](https://github.com/DynamoDS/Dynamo/blob/v4.1.0/src/DynamoUtilities/DebugModes.cs)
...
[Vendor docs](https://github.com/DynamoDS/Dynamo/blob/v4.1.0/src/DynamoCore/Core/CrashPromptArgs.cs)
...
[Vendor docs](https://github.com/DynamoDS/Dynamo/blob/v4.1.0/src/DynamoCore/Configuration/LuceneConfig.cs)
...
[Vendor docs](https://github.com/DynamoDS/Dynamo/blob/v4.1.0/src/DynamoCore/Configuration/PathManager.cs)
...
[Vendor docs](https://github.com/DynamoDS/Dynamo/blob/v4.1.0/src/Engine/ProtoCore/Namespace/ElementRewriter.cs)
...
[Docs](https://github.com/DynamoDS/Dynamo/blob/v4.1.0/src/Engine/ProtoCore/Namespace/ElementRewriter.cs)
...
[Vendor docs](https://github.com/DynamoDS/Dynamo/blob/v4.1.0/src/DynamoCore/Migration/PythonEngineUpgradeService.cs)
...
[Vendor docs](https://github.com/DynamoDS/Dynamo/blob/v4.1.0/src/DynamoCore/Core/UndoRedoRecorder.cs)
...
[Docs](https://github.com/DynamoDS/Dynamo/blob/v4.1.0/src/DynamoUtilities/CertificateVerification.cs)
