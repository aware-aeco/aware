...
description: This skill encodes the dynamo 4.1.0 surface of the Dynamo.Migration namespace — 6 types with full vendor-documented methods, properties, events, and behavioral remarks. Read when composing apps that touch any of: MigrationManager, PortId, NodeMigrationData, NodeMigrationAttribute, WorkspaceMigrationAttribute, WorkspaceMigrations.
---
...
[Vendor docs](https://github.com/DynamoDS/Dynamo/blob/v4.1.0/src/DynamoCore/Migration/WorkspaceMigrations.cs)
...
[Docs](https://github.com/DynamoDS/Dynamo/blob/v4.1.0/src/DynamoCore/Migration/WorkspaceMigrations.cs)
