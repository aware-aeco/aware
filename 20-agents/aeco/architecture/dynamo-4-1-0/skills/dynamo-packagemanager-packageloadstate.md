...
description: This skill encodes the dynamo 4.1.0 surface of the Dynamo.PackageManager.PackageLoadState namespace — 2 types with full vendor-documented methods, properties, events, and behavioral remarks. Read when composing apps that touch any of: StateTypes, ScheduledTypes.
---
