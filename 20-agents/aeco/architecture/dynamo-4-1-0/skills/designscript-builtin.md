...
description: This skill encodes the dynamo 4.1.0 surface of the DesignScript.Builtin namespace — 6 types with full vendor-documented methods, properties, events, and behavioral remarks. Read when composing apps that touch any of: Get, Dictionary, KeyNotFoundException, IndexOutOfRangeException, StringOverIndexingException, BuiltinNullReferenceException.
---
...
[Vendor docs](https://github.com/DynamoDS/Dynamo/blob/v4.1.0/src/Libraries/DesignScriptBuiltin/IndexingExceptions.cs)
...
[Vendor docs](https://github.com/DynamoDS/Dynamo/blob/v4.1.0/src/Libraries/DesignScriptBuiltin/Dictionary.cs)
...
[Docs](https://github.com/DynamoDS/Dynamo/blob/v4.1.0/src/Libraries/DesignScriptBuiltin/Dictionary.cs)
...
[Vendor docs](https://github.com/DynamoDS/Dynamo/blob/v4.1.0/src/Libraries/DesignScriptBuiltin/Builtin.cs)
...
[Docs](https://github.com/DynamoDS/Dynamo/blob/v4.1.0/src/Libraries/DesignScriptBuiltin/Builtin.cs)
