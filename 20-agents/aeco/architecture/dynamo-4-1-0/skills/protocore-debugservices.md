...
description: This skill encodes the dynamo 4.1.0 surface of the ProtoCore.DebugServices namespace — 5 types with full vendor-documented methods, properties, events, and behavioral remarks. Read when composing apps that touch any of: BeginDocument, EndDocument, PrintMessage, EventSink, ConsoleEventSink.
---
