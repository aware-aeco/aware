...
description: This skill encodes the dynamo 4.1.0 surface of the ProtoCore.Namespace namespace — 4 types with full vendor-documented methods, properties, events, and behavioral remarks. Read when composing apps that touch any of: ElementResolver, ElementRewriter, PermuteUtils, Symbol.
---
...
[Vendor docs](https://github.com/DynamoDS/Dynamo/blob/v4.1.0/src/Engine/ProtoCore/Namespace/ElementResolver.cs)
...
[Docs](https://github.com/DynamoDS/Dynamo/blob/v4.1.0/src/Engine/ProtoCore/Namespace/ElementResolver.cs)
