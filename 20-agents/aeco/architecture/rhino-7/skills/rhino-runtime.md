...
description: This skill encodes the rhino 7.0 surface of the Rhino.Runtime namespace — 43 types with full vendor-documented methods, properties, events, and behavioral remarks. Read when composing apps that touch any of: AssemblyResolver, Analytics, CommonObject, CorruptGeometryException, HostUtils, DocumentCollectedException, Interop, LicenseStateChangedEventArgs, and 35 more types.
---

# Rhino.Runtime

Auto-generated from vendor docs for rhino 7.0. 43 types in this namespace.

## AdvancedSetting (enum)

Advanced setting Id

[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/T_Rhino_Runtime_AdvancedSetting.htm)

### Values
- `UseNewDraftAngleAnalysisUi` = `0` — bool Value, defaults to true
...
[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/T_Rhino_Runtime_Analytics.htm)

### Constructors
- `public Analytics(string TrackingID, string Name)` — Construct Analytics class
- `public Analytics(string TrackingID, string Name, string Platform, string InstallerId, string Version)` — Construct Analytics class
...
**Parameters:**
- `data` (System.Collections.Specialized.NameValueCollection) — Name-Value pairs of data to send. Any valid Google Analytics Measurement Protocol parameter is allowed. No input validation is performed.

[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_Analytics_Send.htm)
...
**Parameters:**
- `Category` (System.String) — Event category. We use the feature or subsystem, such as "installer" or "app" or "document" or "loft". Maps to the Google Analytics parameter "ec".

[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_Analytics_Send_1.htm)
...
**Parameters:**
- `Category` (System.String) — Event category. We use the feature or subsystem, such as "installer" or "app" or "document" or "loft". Maps to the Google Analytics parameter "ec".
- `Action` (System.String) — Event action. A verb: "open" or "start" or "option" Maps to the Google Analytics parameter "ea".

[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_Analytics_Send_2.htm)
...
- `Category` (System.String) — Event category. We use the feature or subsystem, such as "installer" or "app" or "document" or "loft". Maps to the Google Analytics parameter "ec".
- `Action` (System.String) — Event action. A verb: "open" or "start" or "option" Maps to the Google Analytics parameter "ea".
- `Label` (System.String) — Event label. Maps to the Google Analytics parameter "el".

[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_Analytics_Send_3.htm)
...
- `Action` (System.String) — Event action. A verb: "open" or "start" or "option" Maps to the Google Analytics parameter "ea".
- `Label` (System.String) — Event label. Maps to the Google Analytics parameter "el".
- `Value` (System.UInt32) — Event value. Maps to the Google Analytics parameter "ev".

[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_Analytics_Send_4.htm)

### Properties
- `AppInstallerId` (String, get/set) — App Installer Id. In Rhino, we use this to differentiate between different builds such as "WIP" and "Commercial". Maps to Google Analytics parameter 'aiid'
- `AppName` (String, get/set) — Name of Application. For example, "Ocelot". Do not include version numbers. Maps to Google Analytics parameter 'an'
- `AppPlatform` (String, get/set) — Platform application is running on. For example "Mac", "Windows". Again, don't include version numbers. Maps to Google Analytics parameter 'ai'
- `AppVersion` (String, get/set) — Application version string. Maps to Google Analytics parameter 'av'
- `GoogleAnalyticsTrackingID` (String, get/set) — Google Analytics Tracking ID
- `UsageStatisticsEnabled` (Boolean, get) — Determine if user allows automatic data collection from Rhino
- `UserId` (Guid, get) — Returns a GUID that allows events to be aggregated by user. There is no way to determine who the end user is based on this GUID, unless the user tells you their ID. On Windows, this uses the registry to store the ID. On Mac, the Hardware UUID is used as the ID.

## AssemblyResolver (class)

Assembly Resolver for the Rhino App Domain.

[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/T_Rhino_Runtime_AssemblyResolver.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_AssemblyResolver_AddSearchFile.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_AssemblyResolver_AddSearchFolder.htm)
...
[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/T_Rhino_Runtime_CommonObject.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_CommonObject_FromBase64String.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_CommonObject_FromJSON.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_CommonObject_FromJSON_1.htm)
...
[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/T_Rhino_Runtime_CorruptGeometryException.htm)
...
[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/T_Rhino_Runtime_DocumentCollectedException.htm)
...
[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/T_Rhino_Runtime_HostUtils.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_HostUtils_AutoInstallPlugInFolder.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_HostUtils_CallFromCoreRhino.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_HostUtils_CheckForRdk.htm)

#### `public static void ClearFpuExceptionStatus()`

Clear FPU exception and busy flags (Intel assembly fnclex)

[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_HostUtils_ClearFpuExceptionStatus.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_HostUtils_CreateCommands_1.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_HostUtils_CreateCommands.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_HostUtils_CreatePlugIn.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_HostUtils_DebugDumpToString.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_HostUtils_DebugDumpToString_1.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_HostUtils_DebugString.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_HostUtils_DebugString_1.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_HostUtils_DisplayOleAlerts.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_HostUtils_ExceptionReport.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_HostUtils_ExceptionReport_1.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_HostUtils_ExecuteNamedCallback.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_HostUtils_FileNameEndsWithRhinoBackupExtension.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_HostUtils_FileNameEndsWithRhinoExtension.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_HostUtils_GetAbsolutePath.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_HostUtils_GetActivePlugInVersionFolders.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_HostUtils_GetActivePlugInVersionFolders_1.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_HostUtils_GetAssemblySearchPaths.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_HostUtils_GetCurrentProcessInfo.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_HostUtils_GetCustomComputeEndpoints.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_HostUtils_GetPlatformService__1.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_HostUtils_GetRhinoDotNetAssembly.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_HostUtils_GetSystemProcessorCount.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_HostUtils_InPlaceConstCast.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_HostUtils_InitializeRhinoCommon.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_HostUtils_InitializeRhinoCommon_RDK.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_HostUtils_InitializeZooClient.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_HostUtils_IsManagedDll.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_HostUtils_IsRhinoBackupFileExtension.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_HostUtils_IsRhinoFileExtension.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_HostUtils_RecordInitInstanceTime.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_HostUtils_RegisterComputeEndpoint.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_HostUtils_RegisterDynamicCommand.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_HostUtils_RegisterNamedCallback.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_HostUtils_RemoveNamedCallback.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_HostUtils_RhinoCommonExceptionHandler.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_HostUtils_SendLogMessageToCloudCallbackProc.htm)

#### `public static void SetInShutDown()`

Informs the runtime that the application is shutting down.

[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_HostUtils_SetInShutDown.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_HostUtils_ShutDownRhinoCommon_RDK.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_HostUtils_UnhandledThreadException.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/E_Rhino_Runtime_HostUtils_OnExceptionReport.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/E_Rhino_Runtime_HostUtils_OnSendLogMessageToCloud.htm)
...
[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/T_Rhino_Runtime_HostUtils_ExceptionReportDelegate.htm)

## HostUtils.LogMessageType (enum)

Represents the type of message that is being sent to the OnSendLogMessageToCloud event

[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/T_Rhino_Runtime_HostUtils_LogMessageType.htm)
...
[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/T_Rhino_Runtime_HostUtils_SendLogMessageToCloudDelegate.htm)
...
[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/T_Rhino_Runtime_IPlatformServiceLocator.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_IPlatformServiceLocator_GetService__1.htm)

## IZooClientUtilities (interface)

Interface implemented in ZooClient and added to Rhino via dependency injection

[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/T_Rhino_Runtime_IZooClientUtilities.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_IZooClientUtilities_AskUserForLicense.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_IZooClientUtilities_CheckInLicense.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_IZooClientUtilities_CheckOutLicense.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_IZooClientUtilities_ConvertLicense.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_IZooClientUtilities_DeleteLicense.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_IZooClientUtilities_Echo.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_IZooClientUtilities_GetCurrentTime.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_IZooClientUtilities_GetLicense.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_IZooClientUtilities_GetLicenseStatus.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_IZooClientUtilities_GetLicenseType.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_IZooClientUtilities_GetOneLicenseStatus.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_IZooClientUtilities_GetRegisteredOwnerInfo.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_IZooClientUtilities_Initialize.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_IZooClientUtilities_IsCheckOutEnabled.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_IZooClientUtilities_LicenseOptionsHandler.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_IZooClientUtilities_LoginToCloudZoo.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_IZooClientUtilities_LogoutOfCloudZoo.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_IZooClientUtilities_ReturnLicense.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_IZooClientUtilities_ReturnLicense_1.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_IZooClientUtilities_ShowBuyLicenseUi.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_IZooClientUtilities_ShowLicenseValidationUi.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_IZooClientUtilities_ShowRhinoExpiredMessage.htm)
...
[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/T_Rhino_Runtime_ImportOptionsSections.htm)
...
[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/T_Rhino_Runtime_Interop.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_Interop_CreateFromNativePointer.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_Interop_FileReadOptionsConstPointer.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_Interop_FileWriteOptionsConstPointer.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_Interop_FontFromPointer.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_Interop_FromOnBrep.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_Interop_FromOnCurve.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_Interop_FromOnMesh.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_Interop_FromOnSurface.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_Interop_NSFontFromFont.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_Interop_NSFontFromFont_1.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_Interop_NativeGeometryConstPointer.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_Interop_NativeGeometryNonConstPointer.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_Interop_NativeNonConstPointer.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_Interop_NativeNonConstPointer_4.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_Interop_NativeNonConstPointer_1.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_Interop_NativeNonConstPointer_2.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_Interop_NativeNonConstPointer_3.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_Interop_NativeRhinoDocPointer.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_Interop_PlugInPointer.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_Interop_RhinoObjectConstPointer.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_Interop_RhinoObjectFromPointer.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_Interop_ToIRhinoViewport.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_Interop_ToOnBrep.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_Interop_ToOnCurve.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_Interop_ToOnMesh.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_Interop_ToOnSurface.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_Interop_ToOnXform.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_Interop_TryCopyFromOnArc.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_Interop_TryCopyToOnArc.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_Interop_ViewCaptureFromPointer.htm)

## LicenseStateChangedEventArgs (class)

Passed to LicenseStateChanged event on RhinoApp

[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/T_Rhino_Runtime_LicenseStateChangedEventArgs.htm)
...
[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/T_Rhino_Runtime_LicenseTypes.htm)
...
[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/T_Rhino_Runtime_Mode.htm)
...
[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/T_Rhino_Runtime_NamedParametersEventArgs.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_NamedParametersEventArgs_Dispose.htm)

#### `protected override void Finalize()`

Finalizer in case Dispose wasn't called

[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_NamedParametersEventArgs_Finalize.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_NamedParametersEventArgs_Set_3.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_NamedParametersEventArgs_Set_7.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_NamedParametersEventArgs_Set_6.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_NamedParametersEventArgs_Set.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_NamedParametersEventArgs_Set_4.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_NamedParametersEventArgs_Set_5.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_NamedParametersEventArgs_Set_8.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_NamedParametersEventArgs_Set_1.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_NamedParametersEventArgs_Set_9.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_NamedParametersEventArgs_Set_10.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_NamedParametersEventArgs_Set_2.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_NamedParametersEventArgs_SetWindowHandle.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_NamedParametersEventArgs_TryGetBool.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_NamedParametersEventArgs_TryGetColor.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_NamedParametersEventArgs_TryGetDouble.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_NamedParametersEventArgs_TryGetGeometry.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_NamedParametersEventArgs_TryGetInt.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_NamedParametersEventArgs_TryGetPoint.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_NamedParametersEventArgs_TryGetRhinoObjects.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_NamedParametersEventArgs_TryGetString.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_NamedParametersEventArgs_TryGetStrings.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_NamedParametersEventArgs_TryGetUnsignedInt.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_NamedParametersEventArgs_TryGetVector.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_NamedParametersEventArgs_TryGetViewport.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_NamedParametersEventArgs_TryGetWindowHandle.htm)
...
[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/T_Rhino_Runtime_NotLicensedException.htm)
...
[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/T_Rhino_Runtime_PythonCompiledCode.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_PythonCompiledCode_Execute.htm)

## PythonScript (class)

Represents a Python script.

[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/T_Rhino_Runtime_PythonScript.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_PythonScript_AddRuntimeAssembly.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_PythonScript_Compile.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_PythonScript_ContainsVariable.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_PythonScript_Create.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_PythonScript_CreateTextEditorControl.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_PythonScript_EvaluateExpression.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_PythonScript_ExecuteFile.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_PythonScript_ExecuteFileInScope.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_PythonScript_ExecuteScript.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_PythonScript_GetSearchPaths.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_PythonScript_GetStackTraceFromException.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_PythonScript_GetVariable.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_PythonScript_GetVariableNames.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_PythonScript_RemoveVariable.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_PythonScript_RuntimeAssemblies.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_PythonScript_SetIntellisenseVariable.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_PythonScript_SetSearchPaths.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_PythonScript_SetVariable.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_PythonScript_SetupScriptContext.htm)
...
[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/T_Rhino_Runtime_RdkNotLoadedException.htm)
...
[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/T_Rhino_Runtime_RiskyAction.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_RiskyAction_Dispose.htm)
...
[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/T_Rhino_Runtime_Skin.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_Skin_HideSplash.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_Skin_OnBeginLoadAtStartPlugIns.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_Skin_OnBeginLoadPlugIn.htm)

#### `protected virtual void OnBuiltInCommandsRegistered()`

Is called when built-in commands are registered.

[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_Skin_OnBuiltInCommandsRegistered.htm)

#### `protected virtual void OnEndLoadAtStartPlugIns()`

Is called after all of the load at start plug-ins have been loaded.

[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_Skin_OnEndLoadAtStartPlugIns.htm)

#### `protected virtual void OnEndLoadPlugIn()`

Is called after each plug-in has been loaded.

[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_Skin_OnEndLoadPlugIn.htm)

#### `protected virtual void OnLicenseCheckCompleted()`

Is called when the license check is completed.

[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_Skin_OnLicenseCheckCompleted.htm)

#### `protected virtual void OnMainFrameWindowCreated()`

Is called when the main frame window is created.

[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_Skin_OnMainFrameWindowCreated.htm)

#### `protected virtual void ShowHelp()`

Called when the "help" splash screen should be shown. Default implementation just calls ShowSplash()

[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_Skin_ShowHelp.htm)

#### `protected virtual void ShowSplash()`

Is called when the splash screen should be shown.

[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_Skin_ShowSplash.htm)
...
[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/T_Rhino_Runtime_TextFields.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_TextFields_Area.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_TextFields_Area_1.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_TextFields_BlockAttributeText.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_TextFields_BlockInstanceCount.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_TextFields_BlockInstanceName.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_TextFields_CurveLength.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_TextFields_CurveLength_1.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_TextFields_Date.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_TextFields_Date_1.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_TextFields_Date_2.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_TextFields_DateModified.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_TextFields_DateModified_1.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_TextFields_DateModified_2.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_TextFields_DetailScale.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_TextFields_DocumentText.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_TextFields_FileName.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_TextFields_FileName_1.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_TextFields_GetInstanceAttributeFields.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_TextFields_GetInstanceAttributeFields_2.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_TextFields_GetInstanceAttributeFields_1.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_TextFields_LayerName.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_TextFields_LayoutUserText.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_TextFields_LayoutUserText_1.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_TextFields_ModelUnits.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_TextFields_Notes.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_TextFields_NumPages.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_TextFields_ObjectLayer.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_TextFields_ObjectName.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_TextFields_ObjectName_1.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_TextFields_PageHeight.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_TextFields_PageName.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_TextFields_PageName_1.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_TextFields_PageNumber.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_TextFields_PageWidth.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_TextFields_PaperName.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_TextFields_PointCoordinate.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_TextFields_UserText.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_TextFields_UserText_1.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_TextFields_UserText_2.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_TextFields_Volume.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_TextFields_Volume_1.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_TextFields_Volume_2.htm)
...
[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/T_Rhino_Runtime_TextFields_InstanceAttributeField.htm)
...
[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/T_Rhino_Runtime_ViewCaptureWriter.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_ViewCaptureWriter_Draw.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_ViewCaptureWriter_DrawBitmap.htm)
...
**Parameters:**
- `center` (System.Drawing.PointF) — [Missing <param name="center"/> documentation for "M:Rhino.Runtime.ViewCaptureWriter.DrawCircle(System.Drawing.PointF,System.Single,System.Drawing.Color,System.Single,System.Drawing.Color)"]
- `diameter` (System.Single) — [Missing <param name="diameter"/> documentation for "M:Rhino.Runtime.ViewCaptureWriter.DrawCircle(System.Drawing.PointF,System.Single,System.Drawing.Color,System.Single,System.Drawing.Color)"]
- `fillColor` (System.Drawing.Color) — [Missing <param name="fillColor"/> documentation for "M:Rhino.Runtime.ViewCaptureWriter.DrawCircle(System.Drawing.PointF,System.Single,System.Drawing.Color,System.Single,System.Drawing.Color)"]
- `strokeWidth` (System.Single) — [Missing <param name="strokeWidth"/> documentation for "M:Rhino.Runtime.ViewCaptureWriter.DrawCircle(System.Drawing.PointF,System.Single,System.Drawing.Color,System.Single,System.Drawing.Color)"]
- `strokeColor` (System.Drawing.Color) — [Missing <param name="strokeColor"/> documentation for "M:Rhino.Runtime.ViewCaptureWriter.DrawCircle(System.Drawing.PointF,System.Single,System.Drawing.Color,System.Single,System.Drawing.Color)"]

[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_ViewCaptureWriter_DrawCircle.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_ViewCaptureWriter_DrawGradientHatch.htm)

#### `protected abstract void DrawPath(ViewCaptureWriter.PathPoint[] points, ViewCaptureWriter.Pen pen, Color brushColor)`



**Parameters:**
- `points` (Rhino.Runtime.ViewCaptureWriter.PathPoint[]) — [Missing <param name="points"/> documentation for "M:Rhino.Runtime.ViewCaptureWriter.DrawPath(Rhino.Runtime.ViewCaptureWriter.PathPoint[],Rhino.Runtime.ViewCaptureWriter.Pen,System.Drawing.Color)"]
- `pen` (Rhino.Runtime.ViewCaptureWriter.Pen) — [Missing <param name="pen"/> documentation for "M:Rhino.Runtime.ViewCaptureWriter.DrawPath(Rhino.Runtime.ViewCaptureWriter.PathPoint[],Rhino.Runtime.ViewCaptureWriter.Pen,System.Drawing.Color)"]
- `brushColor` (System.Drawing.Color) — [Missing <param name="brushColor"/> documentation for "M:Rhino.Runtime.ViewCaptureWriter.DrawPath(Rhino.Runtime.ViewCaptureWriter.PathPoint[],Rhino.Runtime.ViewCaptureWriter.Pen,System.Drawing.Color)"]

[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_ViewCaptureWriter_DrawPath.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_ViewCaptureWriter_DrawRectangle.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_ViewCaptureWriter_DrawScreenText.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_ViewCaptureWriter_FillPolygon.htm)

#### `protected void Flush()`



[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_ViewCaptureWriter_Flush.htm)

#### `protected void PopClipPath()`



[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_ViewCaptureWriter_PopClipPath.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_ViewCaptureWriter_PushClipPath_1.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_ViewCaptureWriter_PushClipPath.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_ViewCaptureWriter_SetClipPath.htm)
...
[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/T_Rhino_Runtime_ViewCaptureWriter_FillProc.htm)

## ViewCaptureWriter.PathPoint (struct)

[Missing <summary> documentation for "T:Rhino.Runtime.ViewCaptureWriter.PathPoint"]

[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/T_Rhino_Runtime_ViewCaptureWriter_PathPoint.htm)
...
[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/T_Rhino_Runtime_ViewCaptureWriter_Pen.htm)
...
[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/T_Rhino_Runtime_ViewCaptureWriter_PointType.htm)
...
[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/T_Rhino_Runtime_ViewCaptureWriter_SetClipRectProc.htm)
...
[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/T_Rhino_Runtime_ViewCaptureWriter_VectorArcProc.htm)
...
[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/T_Rhino_Runtime_ViewCaptureWriter_VectorBitmapProc.htm)
...
[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/T_Rhino_Runtime_ViewCaptureWriter_VectorClipPathProc.htm)
...
[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/T_Rhino_Runtime_ViewCaptureWriter_VectorFillPolygonProc.htm)
...
[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/T_Rhino_Runtime_ViewCaptureWriter_VectorGradientProc.htm)
...
[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/T_Rhino_Runtime_ViewCaptureWriter_VectorPathProc.htm)
...
[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/T_Rhino_Runtime_ViewCaptureWriter_VectorPointProc.htm)
...
[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/T_Rhino_Runtime_ViewCaptureWriter_VectorPolylineProc.htm)
...
[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/T_Rhino_Runtime_ViewCaptureWriter_VectorRoundedRectProc.htm)
...
[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/T_Rhino_Runtime_ViewCaptureWriter_VectorStringProc.htm)
...
[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/T_Rhino_Runtime_ZooClientParameters.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_ZooClientParameters_VerifyLicenseKey.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/7/html/M_Rhino_Runtime_ZooClientParameters_VerifyPreviousVersionLicense.htm)
