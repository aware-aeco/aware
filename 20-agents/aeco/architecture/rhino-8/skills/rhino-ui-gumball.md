...
description: This skill encodes the rhino 8.0 surface of the Rhino.UI.Gumball namespace — 7 types with full vendor-documented methods, properties, events, and behavioral remarks. Read when composing apps that touch any of: GumballDisplayConduit, GumballAppearanceSettings, GumballObject, GumballPickResult, GumballMode, GumballFrame, GumballScaleMode.
---
...
[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/T_Rhino_UI_Gumball_GumballAppearanceSettings.htm)
...
[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/T_Rhino_UI_Gumball_GumballDisplayConduit.htm)

### Constructors
- `[ObsoleteAttribute] public GumballDisplayConduit()` — Initializes a new instance of the GumballDisplayConduit class
- `public GumballDisplayConduit(ActiveSpace space)` — Initializes a new instance of the GumballDisplayConduit class
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_UI_Gumball_GumballDisplayConduit_CheckShiftAndControlKeys.htm)

#### `public void Dispose()`

Releases all resources used by the GumballDisplayConduit

[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_UI_Gumball_GumballDisplayConduit_Dispose.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_UI_Gumball_GumballDisplayConduit_Dispose_1.htm)

#### `protected override void Finalize()`

(Overrides Object.Finalize().)

[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_UI_Gumball_GumballDisplayConduit_Finalize.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_UI_Gumball_GumballDisplayConduit_PickGumball.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_UI_Gumball_GumballDisplayConduit_SetBaseGumball.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_UI_Gumball_GumballDisplayConduit_SetBaseGumball_1.htm)
...
**Parameters:**
- `frame` (Rhino.Geometry.Plane) — [Missing <param name="frame"/> documentation for "M:Rhino.UI.Gumball.GumballDisplayConduit.UpdateGumball(Rhino.Geometry.Plane)"]

**Returns:** `Boolean` — [Missing <returns> documentation for "M:Rhino.UI.Gumball.GumballDisplayConduit.UpdateGumball(Rhino.Geometry.Plane)"]

[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_UI_Gumball_GumballDisplayConduit_UpdateGumball.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_UI_Gumball_GumballDisplayConduit_UpdateGumball_1.htm)
...
- `PickResult` (GumballPickResult, get) — The initial mouse down event sets PickResult.
...
[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/T_Rhino_UI_Gumball_GumballFrame.htm)
...
[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/T_Rhino_UI_Gumball_GumballMode.htm)
...
[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/T_Rhino_UI_Gumball_GumballObject.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_UI_Gumball_GumballObject_Dispose.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_UI_Gumball_GumballObject_Dispose_1.htm)

#### `protected override void Finalize()`

(Overrides Object.Finalize().)

[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_UI_Gumball_GumballObject_Finalize.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_UI_Gumball_GumballObject_SetFromArc.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_UI_Gumball_GumballObject_SetFromBoundingBox.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_UI_Gumball_GumballObject_SetFromBoundingBox_1.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_UI_Gumball_GumballObject_SetFromCircle.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_UI_Gumball_GumballObject_SetFromCurve.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_UI_Gumball_GumballObject_SetFromEllipse.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_UI_Gumball_GumballObject_SetFromExtrusion.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_UI_Gumball_GumballObject_SetFromHatch.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_UI_Gumball_GumballObject_SetFromLight.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_UI_Gumball_GumballObject_SetFromLine.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_UI_Gumball_GumballObject_SetFromPlane.htm)
...
[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/T_Rhino_UI_Gumball_GumballPickResult.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_UI_Gumball_GumballPickResult_SetToDefault.htm)
...
[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/T_Rhino_UI_Gumball_GumballScaleMode.htm)
