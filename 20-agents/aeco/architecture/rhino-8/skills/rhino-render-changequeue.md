...
description: This skill encodes the rhino 8.0 surface of the Rhino.Render.ChangeQueue namespace — 17 types with full vendor-documented methods, properties, events, and behavioral remarks. Read when composing apps that touch any of: ChangeQueue, ClippingPlane, Environment, DynamicObjectTransform, DisplayRenderSettings, GroundPlane, Light, MappingChannel, and 9 more types.
---

# Rhino.Render.ChangeQueue

Auto-generated from vendor docs for rhino 8.0. 17 types in this namespace.
...
[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/T_Rhino_Render_ChangeQueue_ChangeQueue.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_Render_ChangeQueue_ChangeQueue_ApplyClippingPlaneChanges.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_Render_ChangeQueue_ChangeQueue_ApplyDisplayPipelineAttributesChanges.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_Render_ChangeQueue_ChangeQueue_ApplyDynamicClippingPlaneChanges.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_Render_ChangeQueue_ChangeQueue_ApplyDynamicLightChanges.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_Render_ChangeQueue_ChangeQueue_ApplyDynamicObjectTransforms.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_Render_ChangeQueue_ChangeQueue_ApplyEnvironmentChanges.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_Render_ChangeQueue_ChangeQueue_ApplyGroundPlaneChanges.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_Render_ChangeQueue_ChangeQueue_ApplyLightChanges.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_Render_ChangeQueue_ChangeQueue_ApplyLinearWorkflowChanges.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_Render_ChangeQueue_ChangeQueue_ApplyMaterialChanges.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_Render_ChangeQueue_ChangeQueue_ApplyMeshChanges.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_Render_ChangeQueue_ChangeQueue_ApplyMeshInstanceChanges.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_Render_ChangeQueue_ChangeQueue_ApplyRenderSettingsChanges.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_Render_ChangeQueue_ChangeQueue_ApplyRenderSettingsChanges_1.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_Render_ChangeQueue_ChangeQueue_ApplySkylightChanges.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_Render_ChangeQueue_ChangeQueue_ApplySunChanges.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_Render_ChangeQueue_ChangeQueue_ApplyViewChange.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_Render_ChangeQueue_ChangeQueue_AreViewsEqual.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_Render_ChangeQueue_ChangeQueue_BakeFor.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_Render_ChangeQueue_ChangeQueue_BakingSize.htm)

#### `protected virtual uint ContentRenderHash(RenderContent content, CrcRenderHashFlags flags, string excludeParameterNames, LinearWorkflow lw)`
...
**Parameters:**
- `content` (Rhino.Render.RenderContent) — [Missing <param name="content"/> documentation for "M:Rhino.Render.ChangeQueue.ChangeQueue.ContentRenderHash(Rhino.Render.RenderContent,Rhino.Render.CrcRenderHashFlags,System.String,Rhino.Render.LinearWorkflow)"]
- `flags` (Rhino.Render.CrcRenderHashFlags) — [Missing <param name="flags"/> documentation for "M:Rhino.Render.ChangeQueue.ChangeQueue.ContentRenderHash(Rhino.Render.RenderContent,Rhino.Render.CrcRenderHashFlags,System.String,Rhino.Render.LinearWorkflow)"]
- `excludeParameterNames` (System.String) — [Missing <param name="excludeParameterNames"/> documentation for "M:Rhino.Render.ChangeQueue.ChangeQueue.ContentRenderHash(Rhino.Render.RenderContent,Rhino.Render.CrcRenderHashFlags,System.String,Rhino.Render.LinearWorkflow)"]
- `lw` (Rhino.Render.LinearWorkflow) — [Missing <param name="lw"/> documentation for "M:Rhino.Render.ChangeQueue.ChangeQueue.ContentRenderHash(Rhino.Render.RenderContent,Rhino.Render.CrcRenderHashFlags,System.String,Rhino.Render.LinearWorkflow)"]

**Returns:** `UInt32` — [Missing <returns> documentation for "M:Rhino.Render.ChangeQueue.ChangeQueue.ContentRenderHash(Rhino.Render.RenderContent,Rhino.Render.CrcRenderHashFlags,System.String,Rhino.Render.LinearWorkflow)"]

[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_Render_ChangeQueue_ChangeQueue_ContentRenderHash.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_Render_ChangeQueue_ChangeQueue_ConvertCameraBasedLightToWorld.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_Render_ChangeQueue_ChangeQueue_CrcFromGuid.htm)

#### `public void CreateWorld()`

Calls CreateWorld with true passed.

[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_Render_ChangeQueue_ChangeQueue_CreateWorld.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_Render_ChangeQueue_ChangeQueue_CreateWorld_1.htm)

#### `public void Dispose()`

Dispose our ChangeQueue

[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_Render_ChangeQueue_ChangeQueue_Dispose.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_Render_ChangeQueue_ChangeQueue_Dispose_1.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_Render_ChangeQueue_ChangeQueue_EnvironmentForid.htm)

#### `public RenderEnvironment EnvironmentFromOriginalInstanceId(Guid id)`

Get the RenderEnvironment from the ChangeQueue content cache from the original instance id

**Parameters:**
- `id` (System.Guid) — The original instance id

**Returns:** `RenderEnvironment` — RenderEnvironment

[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_Render_ChangeQueue_ChangeQueue_EnvironmentFromOriginalInstanceId.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_Render_ChangeQueue_ChangeQueue_EnvironmentIdForUsage.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_Render_ChangeQueue_ChangeQueue_Flush.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_Render_ChangeQueue_ChangeQueue_GetQueueGroundPlane.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_Render_ChangeQueue_ChangeQueue_GetQueueRenderSettings.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_Render_ChangeQueue_ChangeQueue_GetQueueSceneBoundingBox.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_Render_ChangeQueue_ChangeQueue_GetQueueSkylight.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_Render_ChangeQueue_ChangeQueue_GetQueueSun.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_Render_ChangeQueue_ChangeQueue_GetQueueView.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_Render_ChangeQueue_ChangeQueue_MaterialFromId.htm)

#### `public RenderMaterial MaterialFromOriginalInstanceId(Guid id)`
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_Render_ChangeQueue_ChangeQueue_MaterialFromOriginalInstanceId.htm)

#### `protected virtual void NotifyBeginUpdates()`

Override this when you want to be notified of begin of changes

[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_Render_ChangeQueue_ChangeQueue_NotifyBeginUpdates.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_Render_ChangeQueue_ChangeQueue_NotifyDynamicUpdatesAreAvailable.htm)

#### `protected virtual void NotifyEndUpdates()`

Override this when you want to be notified when change notifications have ended.

[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_Render_ChangeQueue_ChangeQueue_NotifyEndUpdates.htm)

#### `public void OneShot()`

Call Flush() once, after that automatically dispose the queue.

[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_Render_ChangeQueue_ChangeQueue_OneShot.htm)

#### `public Guid[] OriginalInstanceIdsFromEnvironmentId(uint crc)`

Return the collection of original document instance ids assocaited with the Environment id.

**Parameters:**
- `crc` (System.UInt32) — The Environment id

**Returns:** `Guid[]` — [Missing <returns> documentation for "M:Rhino.Render.ChangeQueue.ChangeQueue.OriginalInstanceIdsFromEnvironmentId(System.UInt32)"]

[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_Render_ChangeQueue_ChangeQueue_OriginalInstanceIdsFromEnvironmentId.htm)

#### `public Guid[] OriginalInstanceIdsFromMaterialId(uint crc)`

Return the collection of original document instance ids assocaited with the material id.

**Parameters:**
- `crc` (System.UInt32) — The material id

**Returns:** `Guid[]` — [Missing <returns> documentation for "M:Rhino.Render.ChangeQueue.ChangeQueue.OriginalInstanceIdsFromMaterialId(System.UInt32)"]

[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_Render_ChangeQueue_ChangeQueue_OriginalInstanceIdsFromMaterialId.htm)

#### `public Guid[] OriginalInstanceIdsFromTextureId(uint crc)`

Return the collection of original document instance ids assocaited with the Texture id.

**Parameters:**
- `crc` (System.UInt32) — The Texture id

**Returns:** `Guid[]` — [Missing <returns> documentation for "M:Rhino.Render.ChangeQueue.ChangeQueue.OriginalInstanceIdsFromTextureId(System.UInt32)"]

[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_Render_ChangeQueue_ChangeQueue_OriginalInstanceIdsFromTextureId.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_Render_ChangeQueue_ChangeQueue_ProvideOriginalObject.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_Render_ChangeQueue_ChangeQueue_TextureForId.htm)
...
**Returns:** `RenderTexture` — RenderTexture

[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_Render_ChangeQueue_ChangeQueue_TextureFromOriginalInstanceId.htm)
...
[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/T_Rhino_Render_ChangeQueue_ChangeQueue_BakingFunctions.htm)
...
[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/T_Rhino_Render_ChangeQueue_ClippingPlane.htm)

### Properties
- `Attributes` (ObjectAttributes, get) — Get the ClippingPlaneObject for this clipping plane
- `ClipViewports` (RhinoViewport[], get) — Get an array of RhinoViewports this clipping plane is supposed to clip.
...
- `ViewIds` (List<Guid>, get) — Get list of Viewport IDs this clipping plane is supposed to clip.

## DisplayRenderSettings (class)

ChangeQueue DisplayRenderSettings

[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/T_Rhino_Render_ChangeQueue_DisplayRenderSettings.htm)
...
[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/T_Rhino_Render_ChangeQueue_DynamicObjectTransform.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_Render_ChangeQueue_DynamicObjectTransform_ToString.htm)
...
[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/T_Rhino_Render_ChangeQueue_Environment.htm)

## Environment.FrameBufferFillMode (enum)

Fillmode for background

[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/T_Rhino_Render_ChangeQueue_Environment_FrameBufferFillMode.htm)
...
[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/T_Rhino_Render_ChangeQueue_GroundPlane.htm)
...
[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/T_Rhino_Render_ChangeQueue_Light.htm)
...
[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/T_Rhino_Render_ChangeQueue_Light_Event.htm)
...
[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/T_Rhino_Render_ChangeQueue_MappingChannel.htm)

### Properties
- `Channel` (Int32, get) — Get channel number for this MappingChannel
...
[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/T_Rhino_Render_ChangeQueue_MappingChannelCollection.htm)
...
- `SingleMapping` (MappingChannel, get) — 

## Material (class)

Representation of a Material through the change queue

[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/T_Rhino_Render_ChangeQueue_Material.htm)
...
[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/T_Rhino_Render_ChangeQueue_Mesh.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_Render_ChangeQueue_Mesh_GetMeshes.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_Render_ChangeQueue_Mesh_Id.htm)
...
- `Mappings` (MappingChannel[], get) — Get the mapping channels for this mesh
...
- `SingleMesh` (Mesh, get) — Get the single mesh.

## MeshInstance (class)

Representation of ChangeQueue MeshInstance

[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/T_Rhino_Render_ChangeQueue_MeshInstance.htm)

### Properties
- `Ancestry` (MeshInstance.AncestryRecord[], get) — Returns a the ancestry information for this object. Note well - the ancestry records contain complete copies of the object attributes for each level of the block hierarchy. Please do not be tempted to use the ModelObjectId of the instance objects to look them up in the document - the document may have changed since the change queue entries were added.
- `CastShadows` (Boolean, get) — Return true if mesh instance should cast shadows
- `Decals` (Decals, get) — Read-only access to the decals for this MeshInstance if any. Null if no object attributes exist for this mesh instance.
...
- `ObjectAttributes` (ObjectAttributes, get) — The ObjectAttributes associated with a MeshInstance
- `OcsTransform` (Transform, get) — OCS Transform for the MeshInstance - this is the Object Coordinate System texture mapping transformation set in the texture mapping properties dialog. (identity means no OCS, potentially just simple WCS/WCS Box)
...
## MeshInstance.AncestryRecord (class)

Information about the ancestry of a MeshInstance

[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/T_Rhino_Render_ChangeQueue_MeshInstance_AncestryRecord.htm)

### Constructors
- `public AncestryRecord()` — Initializes a new instance of the MeshInstance.AncestryRecord class
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_Render_ChangeQueue_MeshInstance_AncestryRecord_Dispose.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_Render_ChangeQueue_MeshInstance_AncestryRecord_Dispose_1.htm)

#### `protected override void Finalize()`

Finalizer

[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_Render_ChangeQueue_MeshInstance_AncestryRecord_Finalize.htm)

### Properties
- `DefinitionId` (Guid, get) — The ModelObjectId of the InstanceDefinition
- `ReferenceAttributes` (ObjectAttributes, get) — The object attributes from the InstanceObject
- `ReferenceId` (Guid, get) — The ModelObjectId of the InstanceObject
- `Transform` (Transform, get) — The transform from the InstanceObject

## Skylight (class)

ChangeQueue skylight

[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/T_Rhino_Render_ChangeQueue_Skylight.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_Render_ChangeQueue_Skylight_ToString.htm)
