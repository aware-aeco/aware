...
description: This skill encodes the rhino 8.0 surface of the Rhino.NodeInCode namespace — 3 types with full vendor-documented methods, properties, events, and behavioral remarks. Read when composing apps that touch any of: ComponentFunctionInfo, Components, NodeInCodeTable.
---
...
[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/T_Rhino_NodeInCode_ComponentFunctionInfo.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_NodeInCode_ComponentFunctionInfo_Evaluate.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_NodeInCode_ComponentFunctionInfo_Invoke.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_NodeInCode_ComponentFunctionInfo_InvokeKeepTree.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_NodeInCode_ComponentFunctionInfo_InvokeKeepTreeSilenceWarnings.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_NodeInCode_ComponentFunctionInfo_InvokeSilenceWarnings.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_NodeInCode_ComponentFunctionInfo_ToString.htm)
...
[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/T_Rhino_NodeInCode_Components.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_NodeInCode_Components_FindComponent.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_NodeInCode_Components___getAllFunctions.htm)
...
[Vendor docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/T_Rhino_NodeInCode_NodeInCodeTable.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_NodeInCode_NodeInCodeTable_Add.htm)
...
**Parameters:**
- `fullName` (System.String) — Full name of node

**Returns:** `Boolean` — [Missing <returns> documentation for "M:Rhino.NodeInCode.NodeInCodeTable.Contains(System.String)"]

[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_NodeInCode_NodeInCodeTable_Contains.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_NodeInCode_NodeInCodeTable_GetDynamicMemberNames.htm)

#### `public IEnumerable<ComponentFunctionInfo> GetDynamicMembers()`

Returns component info for all additional names in the table.

**Returns:** `IEnumerable<ComponentFunctionInfo>` — [Missing <returns> documentation for "M:Rhino.NodeInCode.NodeInCodeTable.GetDynamicMembers"]

[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_NodeInCode_NodeInCodeTable_GetDynamicMembers.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_NodeInCode_NodeInCodeTable_TryGetIndex.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_NodeInCode_NodeInCodeTable_TryGetMember.htm)
...
[Docs](https://raw.githubusercontent.com/mcneel/rhinocommon-api-docs/gh-pages/api/RhinoCommon/html/M_Rhino_NodeInCode_NodeInCodeTable_TryInvokeMember.htm)
