...
description: This skill encodes the allplan 2024.0 surface of the HandlePropertiesService namespace — 13 types with full vendor-documented methods, properties, events, and behavioral remarks. Read when composing apps that touch any of: HandlePropertiesService, _CheckBox, _BaseHandlePropUpdate, _Angle, _IncrementButton, _DecrementButton, _Point, _XDistance, and 5 more types.
---
