...
description: This skill encodes the grasshopper 7.0 surface of the Grasshopper.Kernel.Data namespace — 33 types with full vendor-documented methods, properties, events, and behavioral remarks. Read when composing apps that touch any of: GH_BracketMismatchException, GH_IndexRanges, GH_IndexRuleSet, GH_Lexer, GH_LexerCombo, GH_Path, GH_Path.PathLengthComparer, GH_PathOffset, and 25 more types.
---
...
### Properties
- `Dimension` (Int32, get/set) — Gets or sets the value of the path at the given dimension index.
...
**Parameters:**
- `clearSingleNulls` (System.Boolean) — If True, nulls will not be grafted.
...
**Parameters:**
- `path` (Grasshopper.Kernel.Data.GH_Path) — Path of data to graft.
- `clearSingleNulls` (System.Boolean) — If true, nulls will not be grafted.
