...
| Reflected agents | **11** (Tekla 2025/2026 + Revit 2025/2026 + Rhino 7/8 + Grasshopper 7/8 + SketchUp 2025/2026 + xeokit — 771 raw skills · 47,513 commands · auto-generated by `aware build agent --from-nuget` (NuGet ref/), `--from-yard` (YARD HTML), and `--from-npm` (TypeScript .d.ts)) |
| Reference apps | **2** |
