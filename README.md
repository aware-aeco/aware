...
$ claude-code                    # or codex, or opencode — your AI is the runtime
  ✓ plugin: aware-aeco · 74 agents · 3,337 skills
...
├── 20-agents/              # 74 agents · 25 curated + 49 reflected · all Apache 2.0
...
- **<!--stat:agents_total-->74<!--/stat--> agents** — <!--stat:agents_curated-->25<!--/stat--> hand-written + <!--stat:agents_reflected-->49<!--/stat--> auto-generated from vendor SDKs — **all registered** in [`registry-index.json`](./registry-index.json) and installable today.
