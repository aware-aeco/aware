...
| Reflected agents | **8** (Tekla 2025/2026 + Revit 2025/2026 + Rhino 7/8 + Grasshopper 7/8 — 362 raw skills · 43,755 commands · auto-generated by `aware build agent --from-nuget` against vendor reference assemblies) |
| Reference apps | **2** |
