...
| Reflected agents | **12** (Tekla 2025/2026 + Revit 2025/2026 + Rhino 7/8 + Grasshopper 7/8 + SketchUp 2025/2026 + xeokit + three.js — 1,282 raw skills · 50,373 commands · auto-generated by `aware build agent --from-nuget` (NuGet ref/), `--from-yard` (YARD HTML), and `--from-npm` (TypeScript .d.ts)) |
| Reference apps | **2** |
