...
| Reflected agents | **4** (Tekla 2025/2026 + Revit 2025/2026 — 133 raw skills · 21,255 commands · auto-generated by `aware build agent --from-nuget` against vendor reference assemblies) |
| Reference apps | **2** |
