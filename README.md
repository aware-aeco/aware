...
| Reflected agents | **23** (Tekla 2025/2026 + Revit 2025/2026 + Rhino 7/8 + Grasshopper 7/8 + SketchUp 2025/2026 + xeokit + three.js + Slack + CSi API + That Open Components + web-ifc + Speckle Viewer + Allplan 2024/2025 + IDEA StatiCa 25/26 + TSD 25/26 — 1,803 raw skills · 59,895 commands · auto-generated by `aware build agent --from-nuget` (NuGet ref/), `--from-yard` (YARD HTML), `--from-npm` (TypeScript .d.ts), `--from-openapi` (REST spec)) |
| Reference apps | **2** |
