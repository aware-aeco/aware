...
- <!--stat:agents_total-->76<!--/stat--> agents under `20-agents/` — <!--stat:agents_curated-->27<!--/stat--> curated (tekla, trimble-connect, navisworks, microsoft-365, google-workspace, …) + <!--stat:agents_reflected-->49<!--/stat--> reflected (revit, rhino, autocad, idea-statica, …); full list in `registry-index.json`
- <!--stat:skills-->3,341<!--/stat--> skill files
