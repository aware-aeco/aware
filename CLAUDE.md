...
You are working on **AWARE** (`aware-aeco/aware`) — the open-source agentic substrate for AECO. The substrate is content-complete (manifesto, decalog, specs, <!--stat:agents_total-->67<!--/stat--> agents, <!--stat:skills-->3,283<!--/stat--> skills, <!--stat:apps-->7<!--/stat--> reference apps, <!--stat:meta_primitives-->6<!--/stat--> meta-primitives) and the `aware` CLI has shipped (v<!--stat:cli_version-->0.63.1<!--/stat-->). The current focus is the **`aware` CLI** — the runtime binary that executes everything the substrate describes.
...
- <!--stat:agents_total-->67<!--/stat--> agents under `20-agents/` — <!--stat:agents_curated-->18<!--/stat--> curated (tekla, trimble-connect, navisworks, microsoft-365, google-workspace, …) + <!--stat:agents_reflected-->49<!--/stat--> reflected (revit, rhino, autocad, idea-statica, …); full list in `registry-index.json`
- <!--stat:skills-->3,283<!--/stat--> skill files
