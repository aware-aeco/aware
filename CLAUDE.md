...
- <!--stat:agents_total-->75<!--/stat--> agents under `20-agents/` — <!--stat:agents_curated-->26<!--/stat--> curated (tekla, trimble-connect, navisworks, microsoft-365, google-workspace, …) + <!--stat:agents_reflected-->49<!--/stat--> reflected (revit, rhino, autocad, idea-statica, …); full list in `registry-index.json`
- <!--stat:skills-->3,340<!--/stat--> skill files
