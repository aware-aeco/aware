...
You are working on **AWARE** (`aware-aeco/aware`) — the open-source agentic substrate for AECO. The substrate is content-complete (manifesto, decalog, specs, <!--stat:agents_total-->80<!--/stat--> agents, <!--stat:skills-->3,346<!--/stat--> skills, <!--stat:apps-->8<!--/stat--> reference apps, <!--stat:meta_primitives-->12<!--/stat--> meta-primitives) and the `aware` CLI has shipped (v<!--stat:cli_version-->0.143.0<!--/stat-->). The current focus is the **`aware` CLI** — the runtime binary that executes everything the substrate describes.
